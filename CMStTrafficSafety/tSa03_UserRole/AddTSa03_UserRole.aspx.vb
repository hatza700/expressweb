...
' This file implements the code-behind class for AddTSa03_UserRole.aspx.
' App_Code\AddTSa03_UserRole.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTSa03_UserRole
        Inherits BaseApplicationPage
' Code-behind class for the AddTSa03_UserRole page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Thêm người dùng-quyền")      
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm người dùng-quyền"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa03_UserRoleRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TSa03_UserRoleRecordControl.LoadData()
        Me.TSa03_UserRoleRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa03_UserRole/ShowTSa03_UserRoleTable.aspx"
