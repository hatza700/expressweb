...
' This file implements the code-behind class for ShowTSa03_UserRoleTable.aspx.
' App_Code\ShowTSa03_UserRoleTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa03_UserRoleTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa03_UserRoleTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem danh sách người dùng-quyền")        
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TSa03_UserRoleSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTSa03_UserRoleSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TSa03_UserRoleSearch()
      ' or replace the call to GetAutoCompletionList_TSa03_UserRoleSearch().
      Return GetAutoCompletionList_TSa03_UserRoleSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách người dùng-quyền"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa03_UserRoleTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TSa03_UserRoleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTSa03_UserRoleTable.TSa03_UserRoleTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTSa03_UserRoleTable.TSa03_UserRoleTableControl()
            
            Return control.GetAutoCompletionList_TSa03_UserRoleSearch(prefixText, count)
        ...
        Me.TSa03_UserRoleTableControl.LoadData()
        Me.TSa03_UserRoleTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TSa03_UserRoleMenuItem"
                    End If
                End If
