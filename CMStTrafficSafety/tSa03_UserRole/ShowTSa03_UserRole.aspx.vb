...
' This file implements the code-behind class for ShowTSa03_UserRole.aspx.
' App_Code\ShowTSa03_UserRole.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa03_UserRole
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa03_UserRole page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem chi tiết người dùng-quyền")        
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết người dùng-quyền"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa03_UserRole/EditTSa03_UserRole.aspx?TSa03_UserRole={PK}"
