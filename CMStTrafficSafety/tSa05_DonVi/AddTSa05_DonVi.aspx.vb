...
' This file implements the code-behind class for AddTSa05_DonVi.aspx.
' App_Code\AddTSa05_DonVi.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTSa05_DonVi
        Inherits BaseApplicationPage
' Code-behind class for the AddTSa05_DonVi page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
              write_log("Truy cập trang:Thêm Đơn vị")    
      End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa05_DonViRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TSa05_DonViRecordControl.LoadData()
        Me.TSa05_DonViRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa05_DonVi/ShowTSa05_DonViTable.aspx"
