...
' This file implements the code-behind class for ShowTSa05_DonViTable.aspx.
' App_Code\ShowTSa05_DonViTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa05_DonViTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa05_DonViTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem danh sách  Đơn vị")        
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TSa05_DonViSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTSa05_DonViSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TSa05_DonViSearch()
      ' or replace the call to GetAutoCompletionList_TSa05_DonViSearch().
      Return GetAutoCompletionList_TSa05_DonViSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách đơn vị"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa05_DonViTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TSa05_DonViSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTSa05_DonViTable.TSa05_DonViTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTSa05_DonViTable.TSa05_DonViTableControl()
            
            Return control.GetAutoCompletionList_TSa05_DonViSearch(prefixText, count)
        ...
        Me.TSa05_DonViTableControl.LoadData()
        Me.TSa05_DonViTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TSa05_DonViMenuItem"
                    End If
                End If
