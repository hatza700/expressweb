...
' This file implements the code-behind class for EditTSa05_DonVi.aspx.
' App_Code\EditTSa05_DonVi.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTSa05_DonVi
        Inherits BaseApplicationPage
' Code-behind class for the EditTSa05_DonVi page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Sửa  Đơn vị")       
      End Sub
