...
' This file implements the code-behind class for ShowTSa05_DonVi.aspx.
' App_Code\ShowTSa05_DonVi.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa05_DonVi
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa05_DonVi page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem chi tiết Đơn vị")        
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết đơn vị"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa05_DonVi/EditTSa05_DonVi.aspx?TSa05_DonVi={PK}"
