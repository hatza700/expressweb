...
' This file implements the code-behind class for FrontEndLogs.aspx.
' App_Code\FrontEndLogs.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class FrontEndLogs
        Inherits BaseApplicationPage
' Code-behind class for the FrontEndLogs page.
