...
' This file implements the code-behind class for ChangePasswords.aspx.
' App_Code\ChangePasswords.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ChangePasswords
        Inherits BaseApplicationPage
' Code-behind class for the ChangePasswords page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
		  ...
		  write_log("Truy cập trang:Thay đổi mật khẩu")       
