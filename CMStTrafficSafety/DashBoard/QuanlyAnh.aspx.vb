...
' This file implements the code-behind class for QuanlyAnh.aspx.
' App_Code\QuanlyAnh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class QuanlyAnh
        Inherits BaseApplicationPage
' Code-behind class for the QuanlyAnh page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub Page_InitializeEventHandlers(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
            ...
            If Me.Page.IsPostBack = False Or Me.Page.IsPostBack = True Then
                Dim uc As New Control
                uc = LoadControl("uccontrol.ascx")
                Me.PlaceHolder.Controls.Add(uc)
            End If
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Quản lý ảnh trên hệ thống"
        End Sub
