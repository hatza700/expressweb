...
' This file implements the code-behind class for LogOut.aspx.
' App_Code\LogOut.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the LogOut page.
