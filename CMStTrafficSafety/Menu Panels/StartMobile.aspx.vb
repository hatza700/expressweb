...
' This file implements the code-behind class for StartMobile.aspx.
' App_Code\StartMobile.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class StartMobile
        Inherits BaseApplicationPage
' Code-behind class for the StartMobile page.
