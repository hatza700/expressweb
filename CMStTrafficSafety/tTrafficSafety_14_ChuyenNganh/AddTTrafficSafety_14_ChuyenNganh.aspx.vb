...
' This file implements the code-behind class for AddTTrafficSafety_14_ChuyenNganh.aspx.
' App_Code\AddTTrafficSafety_14_ChuyenNganh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_14_ChuyenNganh
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_14_ChuyenNganh page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Thêm Chuyên nghành")       
      End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_14_ChuyenNganhRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_14_ChuyenNganhRecordControl.LoadData()
        Me.TTrafficSafety_14_ChuyenNganhRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_14_ChuyenNganh/ShowTTrafficSafety_14_ChuyenNganhTable.aspx"
