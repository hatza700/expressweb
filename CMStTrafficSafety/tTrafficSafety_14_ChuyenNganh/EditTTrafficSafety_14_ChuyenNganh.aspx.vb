...
' This file implements the code-behind class for EditTTrafficSafety_14_ChuyenNganh.aspx.
' App_Code\EditTTrafficSafety_14_ChuyenNganh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_14_ChuyenNganh
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_14_ChuyenNganh page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Sửa Chuyên nghành")        
      End Sub
