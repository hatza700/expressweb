...
' This file implements the code-behind class for ShowTTrafficSafety_14_ChuyenNganhTable.aspx.
' App_Code\ShowTTrafficSafety_14_ChuyenNganhTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_14_ChuyenNganhTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_14_ChuyenNganhTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách Chuyên nghành")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_14_ChuyenNganhSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_14_ChuyenNganhSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_14_ChuyenNganhSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_14_ChuyenNganhSearch().
      Return GetAutoCompletionList_TTrafficSafety_14_ChuyenNganhSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách chuyên nghành"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_14_ChuyenNganhTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_14_ChuyenNganhSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_14_ChuyenNganhTable.TTrafficSafety_14_ChuyenNganhTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_14_ChuyenNganhTable.TTrafficSafety_14_ChuyenNganhTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_14_ChuyenNganhSearch(prefixText, count)
        ...
        Me.TTrafficSafety_14_ChuyenNganhTableControl.LoadData()
        Me.TTrafficSafety_14_ChuyenNganhTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_14_ChuyenNganhMenuItem"
                    End If
                End If
