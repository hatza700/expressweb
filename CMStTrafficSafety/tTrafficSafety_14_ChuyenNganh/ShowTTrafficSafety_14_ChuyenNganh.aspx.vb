...
' This file implements the code-behind class for ShowTTrafficSafety_14_ChuyenNganh.aspx.
' App_Code\ShowTTrafficSafety_14_ChuyenNganh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_14_ChuyenNganh
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_14_ChuyenNganh page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
              write_log("Truy cập trang:Xem chi tiết Chuyên nghành")    
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết chuyên nghành"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_14_ChuyenNganh/EditTTrafficSafety_14_ChuyenNganh.aspx?TTrafficSafety_14_ChuyenNganh={PK}"
