		...
		<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber1">
				  ...
				  <tr>
				    ...
				    <td class="dhb">
				        <table border="0" cellpadding="0" cellspacing="0">
				            <tr>
								<td class="dialog_header_text">Configuring an Edit Record Page</td>
				            </tr>
				        </table>
				    </td>
		  ...
		  <tr>
			...
			<td class="configureErrorPagesText"><br />
				The Edit button or icon you clicked on is not yet bound to an Edit Record page.<br /><br /> 
				To bind the Edit button or icon to an Edit Record page:<br /><br />
				<ol>
			      <li>If you have not yet created an Edit Record page, use the Application Wizard to create one.<br /><br /></li>
			      <li>Go to the Application Explorer tab, navigate in the tree to the page that contains the Edit button or icon, then click the Properties button on the tool bar.<br /><br />
			      <ul style="list-style-type:disc">
			      	<li>Select the name of the Edit button or icon in the tree.</li>
			      	<li>On the Bindings tab, modify the Redirect URL to point to your Edit Record page.<br />Example:  ../MyPages/MyEditRecordPage.aspx?QueryStringParam={0}</li>
