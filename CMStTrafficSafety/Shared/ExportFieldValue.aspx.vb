...
Namespace CMStTrafficSafety
    Partial Public Class ExportFieldValue
        Inherits CMStTrafficSafety.UI.BaseApplicationPage
...
#End Region
        ...
        Private Const ASSEMBLY_NAME As String = "CMStTrafficSafety.Business"
	...
	End Property
        ...
        Protected Sub ExportData()
            ...
            Try
                ...
                If Not (Me.ImagePercentSize = 0.0) Or Not (Me.ImageHeight = 0 Or Me.ImageWidth = 0) Then
