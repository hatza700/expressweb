<%@ Page Language="vb" AutoEventWireup="true" EnableEventValidation="false" Codefile="Forbidden.aspx.vb" Inherits="CMStTrafficSafety.UI.Forbidden" %>
				  ...
				  <tr>
				    ...
				    <td class="dhb">
				        <table border="0" cellpadding="0" cellspacing="0">
				            <tr>
								<td class="dialog_header_text">Forbidden</td>
				            </tr>
				        </table>
				    </td>				    
