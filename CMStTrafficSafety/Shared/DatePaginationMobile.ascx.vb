...
Partial Public Class DatePaginationMobile
        Inherits BaseApplicationUserControl
        Implements IDatePaginationMobile
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub _IntervalDropdown_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)                
...
#Region "Section 2: Do not modify this section."
        ...
        Private Property Interval_Base() As String
            ...
            Get                
                Return Me._IntervalDropdown.SelectedValue
            End Get
            Set(ByVal value As String)
                If (Me._IntervalDropdown.Items).Count = 0
                    Me._IntervalDropdown.Items.Add(New ListItem(Me.Page.GetResourceValue("Year"), "Year"))
                    Me._IntervalDropdown.Items.Add(New ListItem(Me.Page.GetResourceValue("Quarter"), "Quarter"))
                    Me._IntervalDropdown.Items.Add(New ListItem(Me.Page.GetResourceValue("Month"), "Month"))
                    Me._IntervalDropdown.Items.Add(New ListItem(Me.Page.GetResourceValue("Week"), "Week"))
                    Me._IntervalDropdown.Items.Add(New ListItem(Me.Page.GetResourceValue("Day"), "Day"))
                End If            
                MiscUtils.SetSelectedValue(Me._IntervalDropdown, value)
            End Set
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            AddHandler Me._IntervalDropdown.SelectedIndexChanged, AddressOf _IntervalDropdown_SelectedIndexChanged
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
        ...
        Public Sub _IntervalDropdown_SelectedIndexChanged_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
        ...
        Public Sub SetPeriodsShown(ByVal periodsShown As Integer) Implements IDatePaginationMobile.SetPeriodsShown
            SetPeriodsShown_Base(periodsShown)
        End Sub

        Public Property Interval() As String Implements IDatePaginationMobile.Interval
            Get
        ...
        Public Sub ProcessNextPeriod() Implements IDatePaginationMobile.ProcessNextPeriod
            ProcessNextPeriod_Base()
        End Sub
        
        Public Sub ProcessNextPagePeriod(ByVal periodsShown As Integer) Implements IDatePaginationMobile.ProcessNextPagePeriod
            ProcessNextPagePeriod_Base(periodsShown)
        End Sub
        
        Public Sub ProcessPreviousPeriod() Implements IDatePaginationMobile.ProcessPreviousPeriod
            ProcessPreviousPeriod_Base()
        End Sub
        
        Public Sub ProcessPreviousPagePeriod(ByVal periodsShown As Integer) Implements IDatePaginationMobile.ProcessPreviousPagePeriod
            ProcessPreviousPagePeriod_Base(periodsShown)
        End Sub
        
        Public Property FirstStartDate() As String Implements IDatePaginationMobile.FirstStartDate
            Set(ByVal value As String)
        ...
        Public ReadOnly Property NextPageInterval() As IThemeButtonMobile Implements IDatePaginationMobile.NextPageInterval
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_NextPageInterval"), IThemeButtonMobile)
            End Get
        End Property
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property PageTitle() As System.Web.UI.WebControls.Literal Implements IDatePaginationMobile.PageTitle
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property PreviousPageInterval() As IThemeButtonMobile Implements IDatePaginationMobile.PreviousPageInterval
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_PreviousPageInterval"), IThemeButtonMobile)
            End Get
        End Property
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property StartDate1() As System.Web.UI.WebControls.Literal Implements IDatePaginationMobile.StartDate1
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_StartDate1"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
                
      Public Overrides Property Visible() As Boolean Implements IDatePaginationMobile.Visible
      ...
      End Property
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property IntervalDropdown() As System.Web.UI.WebControls.DropDownList Implements IDatePaginationMobile.IntervalDropdown
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_IntervalDropdown"), System.Web.UI.WebControls.DropDownList)
            End Get
        End Property
