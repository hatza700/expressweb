...
Namespace CMStTrafficSafety.UI
  ...
  ' Code-behind class for the IncludeComponentMobile user control.
Partial Public Class IncludeComponentMobile
        Inherits BaseApplicationUserControl
        Implements IIncludeComponentMobile
#Region "Section 1: Place your customizations here."
      ...
      Public Overrides Sub SaveData() Implements IIncludeComponentMobile.SaveData
          Me.SaveData_Base()
      End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Overrides Property Visible() As Boolean Implements IIncludeComponentMobile.Visible
