...
Imports CMStTrafficSafety.UI.Controls.LargeListSelector
...
#Region "Section 2: Do not modify this section."
        ...
        Public Shared Function GetAutoCompletionList_Base(ByVal startsWithText As String, ByVal containsText As String, ByVal count As Integer) As String()
            ...
            Dim control As CMStTrafficSafety.UI.Controls.LargeListSelector.ItemsTable
            control = New CMStTrafficSafety.UI.Controls.LargeListSelector.ItemsTable
