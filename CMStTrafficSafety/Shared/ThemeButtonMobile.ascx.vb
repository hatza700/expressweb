...
Namespace CMStTrafficSafety.UI
  ...
  ' Code-behind class for the ThemeButtonMobile user control.
Partial Public Class ThemeButtonMobile
        Inherits BaseApplicationUserControl
        Implements IThemeButtonMobile
...
#Region "Section 2: Do not modify this section."
    ...
    Try
        ...
        Public ReadOnly Property Button() As System.Web.UI.WebControls.LinkButton Implements IThemeButtonMobile.Button
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_Button"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
                
      Public Overrides Property Visible() As Boolean Implements IThemeButtonMobile.Visible
