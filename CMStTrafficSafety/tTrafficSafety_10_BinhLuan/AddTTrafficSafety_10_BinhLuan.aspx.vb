...
' This file implements the code-behind class for AddTTrafficSafety_10_BinhLuan.aspx.
' App_Code\AddTTrafficSafety_10_BinhLuan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_10_BinhLuan
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_10_BinhLuan page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 10 Binh Luan"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_10_BinhLuanRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_10_BinhLuanRecordControl.LoadData()
        Me.TTrafficSafety_10_BinhLuanRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_10_BinhLuan/ShowTTrafficSafety_10_BinhLuanTable.aspx"
