...
' This file implements the code-behind class for ShowTTrafficSafety_10_BinhLuan.aspx.
' App_Code\ShowTTrafficSafety_10_BinhLuan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_10_BinhLuan
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_10_BinhLuan page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 10 Binh Luan"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_10_BinhLuan/EditTTrafficSafety_10_BinhLuan.aspx?TTrafficSafety_10_BinhLuan={PK}"
