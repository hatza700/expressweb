...
' This file implements the code-behind class for ShowTTrafficSafety_10_BinhLuanTable.aspx.
' App_Code\ShowTTrafficSafety_10_BinhLuanTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_10_BinhLuanTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_10_BinhLuanTable page.
...
write_log("Truy cập trang:Xem danh sách  Bình luận của độc giả")
	End Sub
...
'      <Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_TTrafficSafety_10_BinhLuanSearch(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetTTrafficSafety_10_BinhLuanSearchCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_10_BinhLuanSearch()
'      ' or replace the call to GetAutoCompletionList_TTrafficSafety_10_BinhLuanSearch().
'      Return GetAutoCompletionList_TTrafficSafety_10_BinhLuanSearch_Base(prefixText, count)
'      End Function
...
Private Function CallCustomStoredProcedureForGridView() As System.Data.DataSet
  ...
  '' parameterList(2) = thirdParameter
	...
	'' the stored procedure does not accept any parameters
            myStoredProcedure = New BaseClasses.Data.StoredProcedure("DatabasetTrafficSafety1", "proc_select_binhluan_chuaduyet", Nothing)
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_10_BinhLuanTableControl.SaveData()
                
        Me.TTrafficSafety_10_BinhLuanTableControl1.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_10_BinhLuanTableControl.LoadData()
        Me.TTrafficSafety_10_BinhLuanTableControl.DataBind()
                
        Me.TTrafficSafety_10_BinhLuanTableControl1.LoadData()
        Me.TTrafficSafety_10_BinhLuanTableControl1.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_10_BinhLuanMenuItem"
                    End If
                End If
