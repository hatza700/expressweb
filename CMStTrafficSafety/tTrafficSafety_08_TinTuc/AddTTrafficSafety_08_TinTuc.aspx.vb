...
' This file implements the code-behind class for AddTTrafficSafety_08_TinTuc.aspx.
' App_Code\AddTTrafficSafety_08_TinTuc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_08_TinTuc
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_08_TinTuc page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            ...
            Me.NoiDung.config.toolbar = New Object() { _
         ...
         New Object() {"Cut", "Copy", "Paste", "PasteText", "PasteFromWord"} _
            ...
            _FileBrowser.SetupCKEditor(NoiDung)
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
          ...
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
            'ScriptManager.RegisterClientScriptBlock(Me, [GetType](), "none11", "<script>get_off();</script>", False)
		...
		Public Sub PushButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Customize by adding code before the call or replace the call to the Base function with your own code.
            If Me.Session("fuckoff") IsNot Nothing = True Then
               ' Me.Page.Response.Write( Me.Session("fuckoff").ToString + "-1asadas")	
            Else
            ...
            If Me.Session("fuckoff") IsNot Nothing = True Then
                _image = Me.Session("fuckoff").ToString.Trim
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_08_TinTucRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_08_TinTucRecordControl.LoadData()
        Me.TTrafficSafety_08_TinTucRecordControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_08_TinTucMenuItem"
                    End If
                End If
    ...
    Try
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_08_TinTuc/ShowTTrafficSafety_08_TinTucTable.aspx"
