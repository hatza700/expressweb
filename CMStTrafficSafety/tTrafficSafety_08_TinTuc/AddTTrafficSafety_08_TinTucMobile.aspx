...
<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.AddTTrafficSafety_08_TinTucMobile" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddTTrafficSafety_08_TinTucMobile.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Mobile.master" Inherits="CMStTrafficSafety.UI.AddTTrafficSafety_08_TinTucMobile" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                      ...
                      <asp:Literal runat="server" id="TTrafficSafety_08_TinTucTitle" Text="&lt;%#String.Concat(&quot;&lt;span class='mobileFontAdjust80'>&quot;, GetResourceValue(&quot;Title:Add&quot;),&quot;  Traffic Safety 08 Tin Tuc&quot;, &quot;&lt;/span>&quot;) %>">	</asp:Literal>
