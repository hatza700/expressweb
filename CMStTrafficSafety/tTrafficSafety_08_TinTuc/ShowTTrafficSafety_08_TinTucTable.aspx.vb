...
' This file implements the code-behind class for ShowTTrafficSafety_08_TinTucTable.aspx.
' App_Code\ShowTTrafficSafety_08_TinTucTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_08_TinTucTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_08_TinTucTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_08_TinTucSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_08_TinTucSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_08_TinTucSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_08_TinTucSearch().
      Return GetAutoCompletionList_TTrafficSafety_08_TinTucSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách tin tức"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_08_TinTucTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_08_TinTucSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_08_TinTucTable.TTrafficSafety_08_TinTucTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_08_TinTucTable.TTrafficSafety_08_TinTucTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_08_TinTucSearch(prefixText, count)
        ...
        Me.TTrafficSafety_08_TinTucTableControl.LoadData()
        Me.TTrafficSafety_08_TinTucTableControl.DataBind()
