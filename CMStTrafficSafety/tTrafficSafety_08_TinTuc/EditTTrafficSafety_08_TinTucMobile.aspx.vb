...
' This file implements the code-behind class for EditTTrafficSafety_08_TinTucMobile.aspx.
' App_Code\EditTTrafficSafety_08_TinTucMobile.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_08_TinTucMobile
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_08_TinTucMobile page.
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Section 2: Do not modify this section."
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            Me.SaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, """ & Me.GetResourceValue("Txt:SaveRecord", "CMStTrafficSafety") & """);")
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Traffic Safety 08 Tin Tuc"
        End Sub
    ...
    End Function
      ...
      End Sub  
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As ImageClickEventArgs)
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_08_TinTucRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_08_TinTucRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_08_TinTucRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_08_TinTucRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_08_TinTucRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_08_TinTucRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_08_TinTucRecordControl.DataSource.GetValue(Me.TTrafficSafety_08_TinTucRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_08_TinTucRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_08_TinTucRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_08_TinTucRecordControl.DataSource, Nothing,variables)
                      End If
