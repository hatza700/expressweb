...
' This file implements the code-behind class for ShowTTrafficSafety_09_VideosTable.aspx.
' App_Code\ShowTTrafficSafety_09_VideosTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_09_VideosTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_09_VideosTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Xem danh sách  Videos")       
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_09_VideosSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_09_VideosSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_09_VideosSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_09_VideosSearch().
      Return GetAutoCompletionList_TTrafficSafety_09_VideosSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách video"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_09_VideosTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_09_VideosSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_09_VideosTable.TTrafficSafety_09_VideosTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_09_VideosTable.TTrafficSafety_09_VideosTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_09_VideosSearch(prefixText, count)
        ...
        Me.TTrafficSafety_09_VideosTableControl.LoadData()
        Me.TTrafficSafety_09_VideosTableControl.DataBind()
