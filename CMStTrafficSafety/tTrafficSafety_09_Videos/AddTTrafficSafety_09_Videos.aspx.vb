...
' This file implements the code-behind class for AddTTrafficSafety_09_Videos.aspx.
' App_Code\AddTTrafficSafety_09_Videos.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_09_Videos
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_09_Videos page.
     ...
     Protected Sub btnDoPost_back_noinhan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDoPost_back_noinhan.Click
           ...
           ' ScriptManager.RegisterClientScriptBlock(Me, [GetType](), "none11", "<script>fuck_off();</script>", False)
            ...
            If str_duongdan_anh.Length > 0 Then
                ...
                Me.AnhMinhHoa.Text = str_duongdan_anh
            End If
        End Sub
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Thêm Videos")      
      End Sub
...
#Region "Section 2: Do not modify this section."
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            AddHandler Me.PushButton1.Click, AddressOf PushButton1_Click
        ...
        Private Sub Base_RegisterPostback()
              ...
              Me.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"PushButton1"))
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_09_VideosRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_09_VideosRecordControl.LoadData()
        Me.TTrafficSafety_09_VideosRecordControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_09_VideosMenuItem"
                    End If
                End If
    ...
    Try
        ...
        ' event handler for PushButton with Layout
        Public Sub PushButton1_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
    ...
    Try
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_09_Videos/ShowTTrafficSafety_09_VideosTable.aspx"
