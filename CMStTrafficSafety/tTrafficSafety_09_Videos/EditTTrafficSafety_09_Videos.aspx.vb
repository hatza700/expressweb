...
' This file implements the code-behind class for EditTTrafficSafety_09_Videos.aspx.
' App_Code\EditTTrafficSafety_09_Videos.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_09_Videos
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_09_Videos page.
...
#Region "Section 1: Place your customizations here."
    Protected Sub btnDoPost_back_noinhan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDoPost_back_noinhan.Click
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Sửa  Videos")      
      End Sub
...
#End Region
        ...
        Protected Sub KieuVideos_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles KieuVideos.SelectedIndexChanged
            Dim _val As Integer
            If Me.Page.IsPostBack = True Then

                _val = Me.KieuVideos.SelectedIndex

                If _val = 0 Then
                    Me.DuongDanVideo_FILE.Visible = False
                    Me.DuongDanVideo_text.Visible = True
                Else
                    Me.DuongDanVideo_FILE.Visible = True
                    Me.DuongDanVideo_text.Visible = False
                End If
