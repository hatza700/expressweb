...
' This file implements the code-behind class for ShowTTrafficSafety_32_menusTable.aspx.
' App_Code\ShowTTrafficSafety_32_menusTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_32_menusTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_32_menusTable page.
    ...
    End Function
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_32_menusSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_32_menusTable.TTrafficSafety_32_menusTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_32_menusTable.TTrafficSafety_32_menusTableControl()
