...
' This file implements the code-behind class for EditTTrafficSafety_32_menusTable.aspx.
' App_Code\EditTTrafficSafety_32_menusTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_32_menusTable
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_32_menusTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_32_menusSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_32_menusSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_32_menusSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_32_menusSearch().
      Return GetAutoCompletionList_TTrafficSafety_32_menusSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Traffic Safety 32 Menus"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_32_menusTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_32_menusSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.EditTTrafficSafety_32_menusTable.TTrafficSafety_32_menusTableControl 
            control = new CMStTrafficSafety.UI.Controls.EditTTrafficSafety_32_menusTable.TTrafficSafety_32_menusTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_32_menusSearch(prefixText, count)
        ...
        Me.TTrafficSafety_32_menusTableControl.LoadData()
        Me.TTrafficSafety_32_menusTableControl.DataBind()
