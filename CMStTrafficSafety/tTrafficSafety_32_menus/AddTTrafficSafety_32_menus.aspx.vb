...
' This file implements the code-behind class for AddTTrafficSafety_32_menus.aspx.
' App_Code\AddTTrafficSafety_32_menus.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_32_menus
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_32_menus page.
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_32_menusRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_32_menusRecordControl.LoadData()
        Me.TTrafficSafety_32_menusRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_32_menusRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_32_menusRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_32_menusRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_32_menusRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_32_menusRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_32_menusRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_32_menusRecordControl.DataSource.GetValue(Me.TTrafficSafety_32_menusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_32_menusRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_32_menusRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_32_menusRecordControl.DataSource, Nothing,variables)
                      End If
