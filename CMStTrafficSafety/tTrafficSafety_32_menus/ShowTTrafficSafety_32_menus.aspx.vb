...
' This file implements the code-behind class for ShowTTrafficSafety_32_menus.aspx.
' App_Code\ShowTTrafficSafety_32_menus.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_32_menus
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_32_menus page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_32_menus/EditTTrafficSafety_32_menus.aspx?TTrafficSafety_32_menus={PK}"
