...
' This file implements the code-behind class for ShowTSa02_RoleTable.aspx.
' App_Code\ShowTSa02_RoleTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa02_RoleTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa02_RoleTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
		...
		write_log("Truy cập trang:Xem danh sách quyền")    
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TSa02_RoleSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTSa02_RoleSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TSa02_RoleSearch()
      ' or replace the call to GetAutoCompletionList_TSa02_RoleSearch().
      Return GetAutoCompletionList_TSa02_RoleSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách quyền"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa02_RoleTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TSa02_RoleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTSa02_RoleTable.TSa02_RoleTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTSa02_RoleTable.TSa02_RoleTableControl()
            
            Return control.GetAutoCompletionList_TSa02_RoleSearch(prefixText, count)
        ...
        Me.TSa02_RoleTableControl.LoadData()
        Me.TSa02_RoleTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TSa02_RoleMenuItem"
                    End If
                End If
