...
' This file implements the code-behind class for AddTSa02_Role.aspx.
' App_Code\AddTSa02_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTSa02_Role
        Inherits BaseApplicationPage
' Code-behind class for the AddTSa02_Role page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Thêm quyền")     
      End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa02_RoleRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TSa02_RoleRecordControl.LoadData()
        Me.TSa02_RoleRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa02_Role/ShowTSa02_RoleTable.aspx"
