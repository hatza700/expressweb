...
' This file implements the code-behind class for ShowTSa02_Role.aspx.
' App_Code\ShowTSa02_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa02_Role
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa02_Role page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Xem chi tiết quyền")     
      End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa02_Role/EditTSa02_Role.aspx?TSa02_Role={PK}"
