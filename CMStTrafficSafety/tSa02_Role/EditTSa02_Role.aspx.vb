...
' This file implements the code-behind class for EditTSa02_Role.aspx.
' App_Code\EditTSa02_Role.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTSa02_Role
        Inherits BaseApplicationPage
' Code-behind class for the EditTSa02_Role page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
              write_log("Truy cập trang:Sửa quyền")    
      End Sub
