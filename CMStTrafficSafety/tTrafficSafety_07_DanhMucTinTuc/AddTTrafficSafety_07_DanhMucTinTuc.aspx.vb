...
' This file implements the code-behind class for AddTTrafficSafety_07_DanhMucTinTuc.aspx.
' App_Code\AddTTrafficSafety_07_DanhMucTinTuc.Controls.vb contains the Table, Row and Record control classes
...
Namespace CMStTrafficSafety.UI
    ...
    Partial Public Class AddTTrafficSafety_07_DanhMucTinTuc
        Inherits BaseApplicationPage
        ' Code-behind class for the AddTTrafficSafety_07_DanhMucTinTuc page.
...
#Region "Section 1: Place your customizations here."
        ...
        Public Sub LoadData()
            ...
            LoadData_Base()
write_log("Truy cập trang:Thêm Danh mục tin tức")
        End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm danh mục tin tức"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_07_DanhMucTinTucRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_07_DanhMucTinTucRecordControl.LoadData()
        Me.TTrafficSafety_07_DanhMucTinTucRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_07_DanhMucTinTuc/ShowTTrafficSafety_07_DanhMucTinTucTable.aspx"
