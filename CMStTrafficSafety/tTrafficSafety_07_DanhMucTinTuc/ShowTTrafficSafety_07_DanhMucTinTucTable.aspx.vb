...
' This file implements the code-behind class for ShowTTrafficSafety_07_DanhMucTinTucTable.aspx.
' App_Code\ShowTTrafficSafety_07_DanhMucTinTucTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_07_DanhMucTinTucTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_07_DanhMucTinTucTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem danh sách  Danh mục tin tức")      
      End Sub
...
'      <Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_TTrafficSafety_07_DanhMucTinTucSearch(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetTTrafficSafety_07_DanhMucTinTucSearchCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_07_DanhMucTinTucSearch()
'      ' or replace the call to GetAutoCompletionList_TTrafficSafety_07_DanhMucTinTucSearch().
'      Return GetAutoCompletionList_TTrafficSafety_07_DanhMucTinTucSearch_Base(prefixText, count)
'      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "XEM DANH MỤC TIN TỨC"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_07_DanhMucTinTucTableControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_07_DanhMucTinTucTableControl.LoadData()
        Me.TTrafficSafety_07_DanhMucTinTucTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_07_DanhMucTinTucMenuItem"
                    End If
                End If
