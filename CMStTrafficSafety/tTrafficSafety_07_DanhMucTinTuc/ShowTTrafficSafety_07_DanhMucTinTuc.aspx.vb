...
' This file implements the code-behind class for ShowTTrafficSafety_07_DanhMucTinTuc.aspx.
' App_Code\ShowTTrafficSafety_07_DanhMucTinTuc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_07_DanhMucTinTuc
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_07_DanhMucTinTuc page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Xem chi tiết Danh mục tin tức")       
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết danh mục tịn tức"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_07_DanhMucTinTuc/EditTTrafficSafety_07_DanhMucTinTuc.aspx?TTrafficSafety_07_DanhMucTinTuc={PK}"
