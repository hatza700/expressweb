...
' This file implements the code-behind class for ShowTSa06_LoaiDonVi.aspx.
' App_Code\ShowTSa06_LoaiDonVi.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa06_LoaiDonVi
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa06_LoaiDonVi page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa06_LoaiDonVi/EditTSa06_LoaiDonVi.aspx?TSa06_LoaiDonVi={PK}"
