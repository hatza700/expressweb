...
' This file implements the code-behind class for AddTSa06_LoaiDonVi.aspx.
' App_Code\AddTSa06_LoaiDonVi.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTSa06_LoaiDonVi
        Inherits BaseApplicationPage
' Code-behind class for the AddTSa06_LoaiDonVi page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " 06 Loai Don Vi"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa06_LoaiDonViRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TSa06_LoaiDonViRecordControl.LoadData()
        Me.TSa06_LoaiDonViRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TSa06_LoaiDonViRecordControl Is Nothing AndAlso Not Me.TSa06_LoaiDonViRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TSa06_LoaiDonViRecordControl.DataSource.ID0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TSa06_LoaiDonViRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TSa06_LoaiDonViRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TSa06_LoaiDonViRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TSa06_LoaiDonViRecordControl.DataSource.GetValue(Me.TSa06_LoaiDonViRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TSa06_LoaiDonViRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TSa06_LoaiDonViRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TSa06_LoaiDonViRecordControl.DataSource, Nothing,variables)
                      End If
