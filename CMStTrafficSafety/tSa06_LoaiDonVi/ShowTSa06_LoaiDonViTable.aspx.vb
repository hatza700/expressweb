...
' This file implements the code-behind class for ShowTSa06_LoaiDonViTable.aspx.
' App_Code\ShowTSa06_LoaiDonViTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa06_LoaiDonViTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa06_LoaiDonViTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TSa06_LoaiDonViSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTSa06_LoaiDonViSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TSa06_LoaiDonViSearch()
      ' or replace the call to GetAutoCompletionList_TSa06_LoaiDonViSearch().
      Return GetAutoCompletionList_TSa06_LoaiDonViSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa06_LoaiDonViTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TSa06_LoaiDonViSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTSa06_LoaiDonViTable.TSa06_LoaiDonViTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTSa06_LoaiDonViTable.TSa06_LoaiDonViTableControl()
            
            Return control.GetAutoCompletionList_TSa06_LoaiDonViSearch(prefixText, count)
        ...
        Me.TSa06_LoaiDonViTableControl.LoadData()
        Me.TSa06_LoaiDonViTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TSa06_LoaiDonViMenuItem"
                    End If
                End If
