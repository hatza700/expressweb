...
' This file implements the code-behind class for AddTTrafficSafety_16_GopY.aspx.
' App_Code\AddTTrafficSafety_16_GopY.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_16_GopY
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_16_GopY page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 16 Gop Y"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_16_GopYRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_16_GopYRecordControl.LoadData()
        Me.TTrafficSafety_16_GopYRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_16_GopY/ShowTTrafficSafety_16_GopYTable.aspx"
