...
' This file implements the code-behind class for ShowTTrafficSafety_16_GopYTable.aspx.
' App_Code\ShowTTrafficSafety_16_GopYTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_16_GopYTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_16_GopYTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_16_GopYSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_16_GopYSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_16_GopYSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_16_GopYSearch().
      Return GetAutoCompletionList_TTrafficSafety_16_GopYSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_16_GopYTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_16_GopYSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_16_GopYTable.TTrafficSafety_16_GopYTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_16_GopYTable.TTrafficSafety_16_GopYTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_16_GopYSearch(prefixText, count)
        ...
        Me.TTrafficSafety_16_GopYTableControl.LoadData()
        Me.TTrafficSafety_16_GopYTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_16_GopYMenuItem"
                    End If
                End If
