...
' This file implements the code-behind class for ShowTTrafficSafety_16_GopY.aspx.
' App_Code\ShowTTrafficSafety_16_GopY.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_16_GopY
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_16_GopY page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Chi tiết câu hỏi của độc giả"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_16_GopY/EditTTrafficSafety_16_GopY.aspx?TTrafficSafety_16_GopY={PK}"
