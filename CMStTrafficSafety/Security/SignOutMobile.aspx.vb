...
' This file implements the code-behind class for SignOutMobile.aspx.
' App_Code\SignOutMobile.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class SignOutMobile
        Inherits BaseApplicationPage
' Code-behind class for the SignOutMobile page.
