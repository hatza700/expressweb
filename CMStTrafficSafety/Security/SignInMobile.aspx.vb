...
' App_Code\SignInMobile.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class SignInMobile
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub OKButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Sub MenuButton_Click(ByVal sender As Object, ByVal args As EventArgs)
...
#Region "Section 2: Do not modify this section."
    ...
    Private signInState As SignInState
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            AddHandler Me.MenuButton.Button.Click, AddressOf MenuButton_Click
    ...
    End Function
      ...
      End Sub  
        ...
        Public Sub OKButton_Click_Base(ByVal sender As Object, ByVal args As ImageClickEventArgs)
    ...
    Try
        ...
        Public Sub EmailLinkButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                      ...
                      Dim url As String = BaseClasses.Configuration.ApplicationSettings.Current.MobileForgotUserPageUrl()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
        ...
        Public Sub MenuButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Menu Panels/StartMobile.aspx"
