    ...
    End Function
      ...
      End Sub  
        ...
        Public Sub DatabindLoginsForEmail()
            ...
            Dim h1, h2, stlTable, stlName, stlPwd, stlPwdval As String
            h1 = GetResourceValue("Txt:UsernameCol")
            h2 = GetResourceValue("Txt:PasswordCol")
            stlTable="style=""font-family:Verdana,Geneva,ms sans serif; font-size:12px;"""
            stlName="style=""width:140px; color:#666666; text-align: right; padding-right:20px;"""
            stlPwd="style=""width:140px; color:#666666; text-align: right; padding-right:20px; vertical-align: top;"""
            stlPwdval="style=""padding-bottom:30px; vertical-align: top;"""
            logList = ""
            For Each logRec As IUserIdentityRecord In logRecs
                Dim uname As String = "<td " & stlName & ">" & h1 & "</td>"
                uname &= "<td>" & "<pre>" & logRec.GetUserName & "</pre>" & "</td>"
