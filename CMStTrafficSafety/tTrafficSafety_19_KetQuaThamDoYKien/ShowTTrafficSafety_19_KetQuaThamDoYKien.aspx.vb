...
' This file implements the code-behind class for ShowTTrafficSafety_19_KetQuaThamDoYKien.aspx.
' App_Code\ShowTTrafficSafety_19_KetQuaThamDoYKien.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_19_KetQuaThamDoYKien
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_19_KetQuaThamDoYKien page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_19_KetQuaThamDoYKien/EditTTrafficSafety_19_KetQuaThamDoYKien.aspx?TTrafficSafety_19_KetQuaThamDoYKien={PK}"
