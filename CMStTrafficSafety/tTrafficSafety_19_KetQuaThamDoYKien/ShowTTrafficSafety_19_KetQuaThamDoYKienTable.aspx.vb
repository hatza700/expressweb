...
' This file implements the code-behind class for ShowTTrafficSafety_19_KetQuaThamDoYKienTable.aspx.
' App_Code\ShowTTrafficSafety_19_KetQuaThamDoYKienTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_19_KetQuaThamDoYKienTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_19_KetQuaThamDoYKienTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_19_KetQuaThamDoYKienSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_19_KetQuaThamDoYKienSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_19_KetQuaThamDoYKienSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_19_KetQuaThamDoYKienSearch().
      Return GetAutoCompletionList_TTrafficSafety_19_KetQuaThamDoYKienSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 19 Ket Qua Tham Do YKien"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_19_KetQuaThamDoYKienTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_19_KetQuaThamDoYKienSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_19_KetQuaThamDoYKienTable.TTrafficSafety_19_KetQuaThamDoYKienTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_19_KetQuaThamDoYKienTable.TTrafficSafety_19_KetQuaThamDoYKienTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_19_KetQuaThamDoYKienSearch(prefixText, count)
        ...
        Me.TTrafficSafety_19_KetQuaThamDoYKienTableControl.LoadData()
        Me.TTrafficSafety_19_KetQuaThamDoYKienTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_19_KetQuaThamDoYKienMenuItem"
                    End If
                End If
