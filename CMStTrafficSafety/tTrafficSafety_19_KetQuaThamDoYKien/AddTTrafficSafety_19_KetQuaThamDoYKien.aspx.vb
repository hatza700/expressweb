...
' This file implements the code-behind class for AddTTrafficSafety_19_KetQuaThamDoYKien.aspx.
' App_Code\AddTTrafficSafety_19_KetQuaThamDoYKien.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_19_KetQuaThamDoYKien
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_19_KetQuaThamDoYKien page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 19 Ket Qua Tham Do YKien"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.LoadData()
        Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource.Id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource.GetValue(Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_19_KetQuaThamDoYKienRecordControl.DataSource, Nothing,variables)
                      End If
