...
' This file implements the code-behind class for ShowTTrafficSafety_11_LinhVucTable.aspx.
' App_Code\ShowTTrafficSafety_11_LinhVucTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_11_LinhVucTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_11_LinhVucTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách Lĩnh vực")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_11_LinhVucSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_11_LinhVucSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_11_LinhVucSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_11_LinhVucSearch().
      Return GetAutoCompletionList_TTrafficSafety_11_LinhVucSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách lĩnh vực"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_11_LinhVucTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_11_LinhVucSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_11_LinhVucTable.TTrafficSafety_11_LinhVucTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_11_LinhVucTable.TTrafficSafety_11_LinhVucTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_11_LinhVucSearch(prefixText, count)
        ...
        Me.TTrafficSafety_11_LinhVucTableControl.LoadData()
        Me.TTrafficSafety_11_LinhVucTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_11_LinhVucMenuItem"
                    End If
                End If
