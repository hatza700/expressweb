...
' This file implements the code-behind class for AddTTrafficSafety_11_LinhVuc.aspx.
' App_Code\AddTTrafficSafety_11_LinhVuc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_11_LinhVuc
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_11_LinhVuc page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Thêm Lĩnh vực")     
      End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_11_LinhVucRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_11_LinhVucRecordControl.LoadData()
        Me.TTrafficSafety_11_LinhVucRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_11_LinhVuc/ShowTTrafficSafety_11_LinhVucTable.aspx"
