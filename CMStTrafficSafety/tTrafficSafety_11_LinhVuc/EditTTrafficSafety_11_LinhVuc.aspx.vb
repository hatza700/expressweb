...
' This file implements the code-behind class for EditTTrafficSafety_11_LinhVuc.aspx.
' App_Code\EditTTrafficSafety_11_LinhVuc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_11_LinhVuc
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_11_LinhVuc page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Sửa Lĩnh vực")      
      End Sub
