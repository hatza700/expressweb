...
' This file implements the code-behind class for AddTTrafficSafety_30_Album_anh_anh.aspx.
' App_Code\AddTTrafficSafety_30_Album_anh_anh.Controls.vb contains the Table, Row and Record control classes
...
Namespace CMStTrafficSafety.UI
    ...
    Partial Public Class AddTTrafficSafety_30_Album_anh_anh
        Inherits BaseApplicationPage
        ' Code-behind class for the AddTTrafficSafety_30_Album_anh_anh page.
...
#End Region
        ...
        Public Sub LoadData()
            ...
            '  ddl_thumuc_hethong.AutoPostBack = True
        End Sub
        ...
        Public Sub Page_InitializeEventHandlers(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
            ...
            'Dim scrManager As ToolkitScriptManager = DirectCast(Page.Master.Controls(0).Controls(0).FindControl("manScript"), ToolkitScriptManager)
            'scrManager.RegisterAsyncPostBackControl(ddl_thumuc_hethong)

            'Me.ddl_thumuc_hethong.SelectedIndexChanged += New System.EventHandler(ddl_thumuc_hethong_SelectedIndexChanged)
        End Sub
