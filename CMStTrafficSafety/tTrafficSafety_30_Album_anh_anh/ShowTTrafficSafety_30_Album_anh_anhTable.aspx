...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowTTrafficSafety_30_Album_anh_anhTable.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.ShowTTrafficSafety_30_Album_anh_anhTable" %>
<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_30_Album_anh_anhTable" %>
...
</td></tr><tr><td><asp:panel id="TTrafficSafety_30_Album_anh_anhTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fila" style="width:150px"><asp:Literal runat="server" id="ThuocAlbumLabel1" Text="= &quot;Thuộc album&quot;">	</asp:Literal></td><td style="width:120px;"><asp:DropDownList runat="server" id="ThuocAlbumFilter" autopostback="True" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList></td><td class="filbc" style="width:1px;"><CMStTrafficSafety:ThemeButton runat="server" id="TTrafficSafety_30_Album_anh_anhFilterButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;CMStTrafficSafety&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;CMStTrafficSafety&quot;) %>" postback="False"></CMStTrafficSafety:ThemeButton> 
</td><td class="filbc" style="width:auto;">&nbsp;</td></tr></table>
...
</td></tr><tr><td class="tre"><table cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th colspan="2"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thcwb" style="padding:0px;vertical-align:middle;"><asp:CheckBox runat="server" id="TTrafficSafety_30_Album_anh_anhToggleAll" onclick="toggleAllCheckboxes(this);">	</asp:CheckBox></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="DuongDanAnhLabel" tooltip="Sort by DuongDanAnh" Text="= &quot;Đường dẫn ảnh&quot;" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="thc" scope="col" style="width:150px;"><asp:LinkButton runat="server" id="ThuocAlbumLabel" tooltip="Sort by ThuocAlbum" Text="= &quot;Thuộc album&quot;" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="thc" scope="col" style="text-align: center;width:60px;"><asp:LinkButton runat="server" id="ThuTuLabel" tooltip="Sort by ThuTu" Text="= &quot;Thứ tự&quot;" CausesValidation="False">	</asp:LinkButton>
...
<tr><td class="ticnb" scope="row"><asp:ImageButton runat="server" id="TTrafficSafety_30_Album_anh_anhRowEditButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_edit.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:EditRecord&quot;, &quot;CMStTrafficSafety&quot;) %>">		
	...
	</asp:ImageButton></td><td class="ticwb"><asp:CheckBox runat="server" id="TTrafficSafety_30_Album_anh_anhRecordRowSelection" onclick="moveToThisTableRow(this);">	</asp:CheckBox></td><td class="ttc"><asp:Literal runat="server" id="DuongDanAnh"></asp:Literal> </td><td class="ttc" style="font-weight:bold;"><asp:Literal runat="server" id="ThuocAlbum"></asp:Literal> </td><td class="ttc" style="text-align: center;width:60px;"><asp:Literal runat="server" id="ThuTu"></asp:Literal> </td><td class="ttc" style="width:60px;text-align:center"><asp:Literal runat="server" id="HoatDong"></asp:Literal> </td></tr></CMStTrafficSafety:TTrafficSafety_30_Album_anh_anhTableControlRow>
</ITEMTEMPLATE>
