...
' This file implements the code-behind class for EditTTrafficSafety_30_Album_anh_anhTable2.aspx.
' App_Code\EditTTrafficSafety_30_Album_anh_anhTable2.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_30_Album_anh_anhTable2
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_30_Album_anh_anhTable2 page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_30_Album_anh_anhSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_30_Album_anh_anhSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_30_Album_anh_anhSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_30_Album_anh_anhSearch().
      Return GetAutoCompletionList_TTrafficSafety_30_Album_anh_anhSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Traffic Safety 30 Album Anh Anh"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_30_Album_anh_anhTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_30_Album_anh_anhSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.EditTTrafficSafety_30_Album_anh_anhTable2.TTrafficSafety_30_Album_anh_anhTableControl 
            control = new CMStTrafficSafety.UI.Controls.EditTTrafficSafety_30_Album_anh_anhTable2.TTrafficSafety_30_Album_anh_anhTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_30_Album_anh_anhSearch(prefixText, count)
        ...
        Me.TTrafficSafety_30_Album_anh_anhTableControl.LoadData()
        Me.TTrafficSafety_30_Album_anh_anhTableControl.DataBind()
