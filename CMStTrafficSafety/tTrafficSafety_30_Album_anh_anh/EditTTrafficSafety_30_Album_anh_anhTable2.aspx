...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditTTrafficSafety_30_Album_anh_anhTable2.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.EditTTrafficSafety_30_Album_anh_anhTable2" %>
<%@ Register Tagprefix="CMStTrafficSafety" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.EditTTrafficSafety_30_Album_anh_anhTable2" %>
...
</td><td class="filbc"><CMStTrafficSafety:ThemeButton runat="server" id="TTrafficSafety_30_Album_anh_anhSearchButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;CMStTrafficSafety&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;CMStTrafficSafety&quot;) %>" postback="False"></CMStTrafficSafety:ThemeButton></td></tr><tr><td class="fila"><asp:Literal runat="server" id="DuongDanAnhLabel1" Text="= &quot;Đường dẫn ảnh&quot;">	</asp:Literal></td><td><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("TTrafficSafety_30_Album_anh_anhFilterButton"))%>
<asp:DropDownList runat="server" id="DuongDanAnhFilter" autopostback="True" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("TTrafficSafety_30_Album_anh_anhFilterButton"))%>
</td><td class="filbc" rowspan="2"></td></tr><tr><td class="fila"><asp:Literal runat="server" id="ThuocAlbumLabel1" Text="= &quot;Thuộc album&quot;">	</asp:Literal></td><td><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("TTrafficSafety_30_Album_anh_anhFilterButton"))%>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="ThuTuTextBoxMaxLengthValidator" ControlToValidate="ThuTu" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;ThuTu&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="ttc" style="white-space:nowrap;"><asp:DropDownList runat="server" id="ThuocAlbum" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList>
<Selectors:FvLlsHyperLink runat="server" id="ThuocAlbumFvLlsHyperLink" ControlToUpdate="ThuocAlbum" Text="&lt;%# GetResourceValue(&quot;LLS:Text&quot;, &quot;CMStTrafficSafety&quot;) %>" MinListItems="100" Table="tTrafficSafety_29_Album_anh" Field="TTrafficSafety_29_Album_anh_.albumid" DisplayField="%3d+TTrafficSafety_29_Album_anh.TenAlbum"></Selectors:FvLlsHyperLink> 
<asp:ImageButton runat="server" id="ThuocAlbumAddRecordLink" causesvalidation="False" commandname="Redirect" imageurl="../Images/iconNewFlat.gif" tooltip="&lt;%# GetResourceValue(&quot;Btn:Add&quot;, &quot;CMStTrafficSafety&quot;) %>">		
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="IpSuaTextBoxMaxLengthValidator" ControlToValidate="IpSua" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;IpSua&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td><td class="ttc"><asp:CheckBox runat="server" id="HoatDong"></asp:CheckBox> </td><td class="ttc" style=""><custom:CustomEditor ID="GhiChu" runat="server" GhiChuRequiredFieldValidator:Enabled="False" GhiChuRequiredFieldValidator:Text="*" Height="220" Width="335" AutoFocus="False" /> </td></tr></CMStTrafficSafety:TTrafficSafety_30_Album_anh_anhTableControlRow>
</ITEMTEMPLATE>
...
<asp:Button runat="server" id="PushButton" causesvalidation="False" commandname="Redirect" consumers="page">		
