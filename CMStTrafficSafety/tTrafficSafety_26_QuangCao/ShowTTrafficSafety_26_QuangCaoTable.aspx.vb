...
' This file implements the code-behind class for ShowTTrafficSafety_26_QuangCaoTable.aspx.
' App_Code\ShowTTrafficSafety_26_QuangCaoTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_26_QuangCaoTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_26_QuangCaoTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách quảng cáo")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_26_QuangCaoSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_26_QuangCaoSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_26_QuangCaoSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_26_QuangCaoSearch().
      Return GetAutoCompletionList_TTrafficSafety_26_QuangCaoSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách quảng cáo"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_26_QuangCaoTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_26_QuangCaoSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_26_QuangCaoTable.TTrafficSafety_26_QuangCaoTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_26_QuangCaoTable.TTrafficSafety_26_QuangCaoTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_26_QuangCaoSearch(prefixText, count)
        ...
        Me.TTrafficSafety_26_QuangCaoTableControl.LoadData()
        Me.TTrafficSafety_26_QuangCaoTableControl.DataBind()
