...
' This file implements the code-behind class for EditTTrafficSafety_26_QuangCao.aspx.
' App_Code\EditTTrafficSafety_26_QuangCao.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_26_QuangCao
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_26_QuangCao page.
...
#Region "Section 1: Place your customizations here."
     ...
     Protected Sub btnDoPost_back_noinhan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDoPost_back_noinhan.Click
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Sửa quảng cáo")     
