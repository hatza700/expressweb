<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditTTrafficSafety_26_QuangCao.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.EditTTrafficSafety_26_QuangCao" %>
<%@ Register Tagprefix="Selectors" Namespace="CMStTrafficSafety" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="CMStTrafficSafety" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.EditTTrafficSafety_26_QuangCao" %>
...
<CMStTrafficSafety:TTrafficSafety_26_QuangCaoRecordControl runat="server" id="TTrafficSafety_26_QuangCaoRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="TTrafficSafety_26_QuangCaoTitle" Text="Sửa quảng cáo">	</asp:Literal></td></tr></table>
...
<div id="bMulti" style='background-color:#fff;' class="bMulti">
    ...
    <br />
    </div></td><td class="dfv" style="white-space:nowrap;width:auto">&nbsp;</td></tr><tr><td class="fls"><asp:Literal runat="server" id="LinkLienKetLabel" Text="= &quot;Địa chỉ website&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;" colspan="2"><asp:TextBox runat="server" id="LinkLienKet" MaxLength="50" columns="60" cssclass="field_input" rows="1" textmode="SingleLine" width="500px"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="LinkLienKetTextBoxMaxLengthValidator" ControlToValidate="LinkLienKet" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;LinkLienKet&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="ViTriLabel" Text="= &quot;Vị trí quảng cáo&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;" colspan="2"><asp:RadioButtonList runat="server" id="ViTri" RepeatLayout="Flow" autopostback="True" repeatdirection="Horizontal" width="257px"></asp:RadioButtonList></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"></td><td class="dfv" style="white-space:nowrap;" colspan="2"><asp:dropdownlist cssclass="Filter_Input" id="DropDownList" runat="server" /></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="ThoiGianBatDauLabel" Text="= &quot;Thời gian bắt đầu&quot;">	</asp:Literal></td><td class="dfv" colspan="2"><table border="0" cellpadding="0" cellspacing="0">
<tr>
...
</td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="ThoiGianKetThucLabel" Text="= &quot;Thời gian kết thúc&quot;">	</asp:Literal></td><td class="dfv" colspan="2"><table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="ThuTuLabel" Text="= &quot;Thứ tự&quot;">	</asp:Literal></td><td class="dfv" colspan="2"><table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
</td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="HoatDongLabel" Text="= &quot;Hoạt động&quot;">	</asp:Literal></td><td class="dfv" colspan="2"><asp:CheckBox runat="server" id="HoatDong"></asp:CheckBox></td><td class="dfv"></td></tr></table></asp:panel>
</td></tr></table>
