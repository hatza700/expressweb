...
' This file implements the code-behind class for AddTTrafficSafety_23_KieuNoiDung.aspx.
' App_Code\AddTTrafficSafety_23_KieuNoiDung.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_23_KieuNoiDung
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_23_KieuNoiDung page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 23 Kieu Noi Dung"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_23_KieuNoiDungRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_23_KieuNoiDungRecordControl.LoadData()
        Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_23_KieuNoiDungRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource.GetValue(Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_23_KieuNoiDungRecordControl.DataSource, Nothing,variables)
                      End If
