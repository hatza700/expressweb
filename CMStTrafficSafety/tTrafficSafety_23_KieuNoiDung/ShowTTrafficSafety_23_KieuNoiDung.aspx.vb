...
' This file implements the code-behind class for ShowTTrafficSafety_23_KieuNoiDung.aspx.
' App_Code\ShowTTrafficSafety_23_KieuNoiDung.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_23_KieuNoiDung
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_23_KieuNoiDung page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_23_KieuNoiDung/EditTTrafficSafety_23_KieuNoiDung.aspx?TTrafficSafety_23_KieuNoiDung={PK}"
