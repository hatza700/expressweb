...
' This file implements the code-behind class for ShowTTrafficSafety_23_KieuNoiDungTable.aspx.
' App_Code\ShowTTrafficSafety_23_KieuNoiDungTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_23_KieuNoiDungTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_23_KieuNoiDungTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_23_KieuNoiDungSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_23_KieuNoiDungSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_23_KieuNoiDungSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_23_KieuNoiDungSearch().
      Return GetAutoCompletionList_TTrafficSafety_23_KieuNoiDungSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 23 Kieu Noi Dung"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_23_KieuNoiDungTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_23_KieuNoiDungSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_23_KieuNoiDungTable.TTrafficSafety_23_KieuNoiDungTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_23_KieuNoiDungTable.TTrafficSafety_23_KieuNoiDungTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_23_KieuNoiDungSearch(prefixText, count)
        ...
        Me.TTrafficSafety_23_KieuNoiDungTableControl.LoadData()
        Me.TTrafficSafety_23_KieuNoiDungTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_23_KieuNoiDungMenuItem"
                    End If
                End If
