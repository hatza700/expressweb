...
' This file implements the code-behind class for EditTTrafficSafety_31_type_menuTable.aspx.
' App_Code\EditTTrafficSafety_31_type_menuTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_31_type_menuTable
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_31_type_menuTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_31_type_menuSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_31_type_menuSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_31_type_menuSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_31_type_menuSearch().
      Return GetAutoCompletionList_TTrafficSafety_31_type_menuSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Traffic Safety 31 Type Menu"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_31_type_menuTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_31_type_menuSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.EditTTrafficSafety_31_type_menuTable.TTrafficSafety_31_type_menuTableControl 
            control = new CMStTrafficSafety.UI.Controls.EditTTrafficSafety_31_type_menuTable.TTrafficSafety_31_type_menuTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_31_type_menuSearch(prefixText, count)
        ...
        Me.TTrafficSafety_31_type_menuTableControl.LoadData()
        Me.TTrafficSafety_31_type_menuTableControl.DataBind()
