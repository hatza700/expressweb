...
' This file implements the code-behind class for AddTTrafficSafety_31_type_menu.aspx.
' App_Code\AddTTrafficSafety_31_type_menu.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_31_type_menu
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_31_type_menu page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 31 Type Menu"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_31_type_menuRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_31_type_menuRecordControl.LoadData()
        Me.TTrafficSafety_31_type_menuRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_31_type_menuRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_31_type_menuRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_31_type_menuRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_31_type_menuRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_31_type_menuRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_31_type_menuRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_31_type_menuRecordControl.DataSource.GetValue(Me.TTrafficSafety_31_type_menuRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_31_type_menuRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_31_type_menuRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_31_type_menuRecordControl.DataSource, Nothing,variables)
                      End If
