...
' This file implements the code-behind class for AddTTrafficSafety_13_CoQuanBanHanh.aspx.
' App_Code\AddTTrafficSafety_13_CoQuanBanHanh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_13_CoQuanBanHanh
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_13_CoQuanBanHanh page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Thêm Cơ quan ban hành")       
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm cơ quan ban hành"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_13_CoQuanBanHanhRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_13_CoQuanBanHanhRecordControl.LoadData()
        Me.TTrafficSafety_13_CoQuanBanHanhRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_13_CoQuanBanHanh/ShowTTrafficSafety_13_CoQuanBanHanhTable.aspx"
