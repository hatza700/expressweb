...
' This file implements the code-behind class for ShowTTrafficSafety_13_CoQuanBanHanhTable.aspx.
' App_Code\ShowTTrafficSafety_13_CoQuanBanHanhTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_13_CoQuanBanHanhTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_13_CoQuanBanHanhTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem danh sách Cơ quan ban hành")        
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_13_CoQuanBanHanhSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_13_CoQuanBanHanhSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_13_CoQuanBanHanhSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_13_CoQuanBanHanhSearch().
      Return GetAutoCompletionList_TTrafficSafety_13_CoQuanBanHanhSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách cơ quan ban hành"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_13_CoQuanBanHanhTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_13_CoQuanBanHanhSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_13_CoQuanBanHanhTable.TTrafficSafety_13_CoQuanBanHanhTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_13_CoQuanBanHanhTable.TTrafficSafety_13_CoQuanBanHanhTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_13_CoQuanBanHanhSearch(prefixText, count)
        ...
        Me.TTrafficSafety_13_CoQuanBanHanhTableControl.LoadData()
        Me.TTrafficSafety_13_CoQuanBanHanhTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_13_CoQuanBanHanhMenuItem"
                    End If
                End If
