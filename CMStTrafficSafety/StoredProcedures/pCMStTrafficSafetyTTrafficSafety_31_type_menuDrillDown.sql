if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_31_type_menuDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_31_type_menuDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_31_type_menuDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_31_type_menu_]' +
