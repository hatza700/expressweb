if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_10_BinhLuanDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_10_BinhLuanDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_10_BinhLuanDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_10_BinhLuan_]' +
