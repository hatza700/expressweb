if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_23_KieuNoiDungDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_23_KieuNoiDungDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_23_KieuNoiDungDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_23_KieuNoiDung_]' +
