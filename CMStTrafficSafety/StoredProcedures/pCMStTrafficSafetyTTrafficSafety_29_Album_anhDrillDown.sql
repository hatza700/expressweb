if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_29_Album_anhDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_29_Album_anhDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_29_Album_anhDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_29_Album_anh_]' +
