if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_22_HienThiTieuDeModuleGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_22_HienThiTieuDeModuleGetList 
GO
...
-- Returns a query resultset from table [dbo].[tTrafficSafety_22_HienThiTieuDeModule]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_22_HienThiTieuDeModuleGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tTrafficSafety_22_HienThiTieuDeModule] TTrafficSafety_22_HienThiTieuDeModule_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TTrafficSafety_22_HienThiTieuDeModule_.[id] asc '
        ...
        SET @l_temp_colsWithAlias = 
            N'TTrafficSafety_22_HienThiTieuDeModule_.[id]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
        ...
        SET @l_query_cols = 
            N'TTrafficSafety_22_HienThiTieuDeModule_.[id],
            TTrafficSafety_22_HienThiTieuDeModule_.[KieuHienThi],
            TTrafficSafety_22_HienThiTieuDeModule_.[GhiChu],
            CAST(BINARY_CHECKSUM(TTrafficSafety_22_HienThiTieuDeModule_.[id],TTrafficSafety_22_HienThiTieuDeModule_.[KieuHienThi],TTrafficSafety_22_HienThiTieuDeModule_.[GhiChu]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TTrafficSafety_22_HienThiTieuDeModule_.[id] = IS_ALIAS.[id] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TTrafficSafety_22_HienThiTieuDeModule_.[id],TTrafficSafety_22_HienThiTieuDeModule_.[KieuHienThi],TTrafficSafety_22_HienThiTieuDeModule_.[GhiChu]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tTrafficSafety_22_HienThiTieuDeModule] TTrafficSafety_22_HienThiTieuDeModule_ ' + 
            'WHERE 1=2;'
