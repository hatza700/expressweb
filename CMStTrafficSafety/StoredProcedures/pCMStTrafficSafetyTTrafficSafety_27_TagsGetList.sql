if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_27_TagsGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_27_TagsGetList 
GO
...
-- Returns a query resultset from table [dbo].[tTrafficSafety_27_Tags]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_27_TagsGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tTrafficSafety_27_Tags] TTrafficSafety_27_Tags_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TTrafficSafety_27_Tags_.[id] asc '
        ...
        SET @l_query_cols = 
            N'TTrafficSafety_27_Tags_.[id],
            TTrafficSafety_27_Tags_.[tags],
            CAST(BINARY_CHECKSUM(TTrafficSafety_27_Tags_.[id],TTrafficSafety_27_Tags_.[tags]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TTrafficSafety_27_Tags_.[id] = IS_ALIAS.[id] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TTrafficSafety_27_Tags_.[id],TTrafficSafety_27_Tags_.[tags]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tTrafficSafety_27_Tags] TTrafficSafety_27_Tags_ ' + 
            'WHERE 1=2;'
