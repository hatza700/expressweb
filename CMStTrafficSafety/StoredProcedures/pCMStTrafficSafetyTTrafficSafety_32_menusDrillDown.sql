if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_32_menusDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_32_menusDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_32_menusDrillDown
