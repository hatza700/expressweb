if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_24_ViTriQuangCaoGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_24_ViTriQuangCaoGetList 
GO
...
-- Returns a query resultset from table [dbo].[tTrafficSafety_24_ViTriQuangCao]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_24_ViTriQuangCaoGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tTrafficSafety_24_ViTriQuangCao] TTrafficSafety_24_ViTriQuangCao_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TTrafficSafety_24_ViTriQuangCao_.[Id] asc '
        ...
        SET @l_temp_colsWithAlias = 
            N'TTrafficSafety_24_ViTriQuangCao_.[Id]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
        ...
        SET @l_query_cols = 
            N'TTrafficSafety_24_ViTriQuangCao_.[Id],
            TTrafficSafety_24_ViTriQuangCao_.[ViTri],
            CAST(BINARY_CHECKSUM(TTrafficSafety_24_ViTriQuangCao_.[Id],TTrafficSafety_24_ViTriQuangCao_.[ViTri]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TTrafficSafety_24_ViTriQuangCao_.[Id] = IS_ALIAS.[Id] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TTrafficSafety_24_ViTriQuangCao_.[Id],TTrafficSafety_24_ViTriQuangCao_.[ViTri]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tTrafficSafety_24_ViTriQuangCao] TTrafficSafety_24_ViTriQuangCao_ ' + 
            'WHERE 1=2;'
