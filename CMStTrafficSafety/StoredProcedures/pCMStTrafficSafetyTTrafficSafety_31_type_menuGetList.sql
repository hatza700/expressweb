if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_31_type_menuGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_31_type_menuGetList 
GO
...
-- Returns a query resultset from table [dbo].[tTrafficSafety_31_type_menu]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_31_type_menuGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tTrafficSafety_31_type_menu] TTrafficSafety_31_type_menu_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TTrafficSafety_31_type_menu_.[id] asc '
        ...
        SET @l_temp_colsWithAlias = 
            N'TTrafficSafety_31_type_menu_.[id]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
        ...
        SET @l_query_cols = 
            N'TTrafficSafety_31_type_menu_.[id],
            TTrafficSafety_31_type_menu_.[TenKieuMenu],
            TTrafficSafety_31_type_menu_.[GhiChu],
            CAST(BINARY_CHECKSUM(TTrafficSafety_31_type_menu_.[id],TTrafficSafety_31_type_menu_.[TenKieuMenu],TTrafficSafety_31_type_menu_.[GhiChu]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TTrafficSafety_31_type_menu_.[id] = IS_ALIAS.[id] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TTrafficSafety_31_type_menu_.[id],TTrafficSafety_31_type_menu_.[TenKieuMenu],TTrafficSafety_31_type_menu_.[GhiChu]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tTrafficSafety_31_type_menu] TTrafficSafety_31_type_menu_ ' + 
            'WHERE 1=2;'
