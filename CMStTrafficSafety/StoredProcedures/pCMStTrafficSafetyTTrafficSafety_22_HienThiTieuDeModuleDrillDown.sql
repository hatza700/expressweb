if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_22_HienThiTieuDeModuleDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_22_HienThiTieuDeModuleDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_22_HienThiTieuDeModuleDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_22_HienThiTieuDeModule_]' +
