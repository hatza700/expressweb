if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTSa06_LoaiDonViGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTSa06_LoaiDonViGetList 
GO
...
-- Returns a query resultset from table [dbo].[tSa06_LoaiDonVi]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTSa06_LoaiDonViGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tSa06_LoaiDonVi] TSa06_LoaiDonVi_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TSa06_LoaiDonVi_.[ID] asc '
        ...
        SET @l_query_cols = 
            N'TSa06_LoaiDonVi_.[ID],
            TSa06_LoaiDonVi_.[LoaiDonVi],
            TSa06_LoaiDonVi_.[ThuTu],
            TSa06_LoaiDonVi_.[HoatDong],
            TSa06_LoaiDonVi_.[GhiChu],
            TSa06_LoaiDonVi_.[NguoiTao],
            TSa06_LoaiDonVi_.[ThoiGianTao],
            TSa06_LoaiDonVi_.[IpTao],
            TSa06_LoaiDonVi_.[NguoiSua],
            TSa06_LoaiDonVi_.[ThoiGianSua],
            TSa06_LoaiDonVi_.[IpSua],
            CAST(BINARY_CHECKSUM(TSa06_LoaiDonVi_.[ID],TSa06_LoaiDonVi_.[LoaiDonVi],TSa06_LoaiDonVi_.[ThuTu],TSa06_LoaiDonVi_.[HoatDong],TSa06_LoaiDonVi_.[GhiChu],TSa06_LoaiDonVi_.[NguoiTao],TSa06_LoaiDonVi_.[ThoiGianTao],TSa06_LoaiDonVi_.[IpTao],TSa06_LoaiDonVi_.[NguoiSua],TSa06_LoaiDonVi_.[ThoiGianSua],TSa06_LoaiDonVi_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TSa06_LoaiDonVi_.[ID] = IS_ALIAS.[ID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TSa06_LoaiDonVi_.[ID],TSa06_LoaiDonVi_.[LoaiDonVi],TSa06_LoaiDonVi_.[ThuTu],TSa06_LoaiDonVi_.[HoatDong],TSa06_LoaiDonVi_.[GhiChu],TSa06_LoaiDonVi_.[NguoiTao],TSa06_LoaiDonVi_.[ThoiGianTao],TSa06_LoaiDonVi_.[IpTao],TSa06_LoaiDonVi_.[NguoiSua],TSa06_LoaiDonVi_.[ThoiGianSua],TSa06_LoaiDonVi_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tSa06_LoaiDonVi] TSa06_LoaiDonVi_ ' + 
            'WHERE 1=2;'
