if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_15_VanBanDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_15_VanBanDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_15_VanBanDrillDown
