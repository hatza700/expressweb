if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_13_CoQuanBanHanhDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_13_CoQuanBanHanhDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_13_CoQuanBanHanhDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_13_CoQuanBanHanh_]' +
