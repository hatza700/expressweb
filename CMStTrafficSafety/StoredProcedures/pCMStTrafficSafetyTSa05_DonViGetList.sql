if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTSa05_DonViGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTSa05_DonViGetList 
GO
...
-- Returns a query resultset from table [dbo].[tSa05_DonVi]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTSa05_DonViGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TSa05_DonVi_.[ID] asc '
        ...
        SET @l_query_cols = 
            N'TSa05_DonVi_.[ID],
            TSa05_DonVi_.[TenTat],
            TSa05_DonVi_.[TenDonVi],
            TSa05_DonVi_.[LoaiDonViID],
            TSa05_DonVi_.[DiaChi],
            TSa05_DonVi_.[ThuTu],
            TSa05_DonVi_.[HoatDong],
            TSa05_DonVi_.[GhiChu],
            TSa05_DonVi_.[NguoiTao],
            TSa05_DonVi_.[ThoiGianTao],
            TSa05_DonVi_.[IpTao],
            TSa05_DonVi_.[NguoiSua],
            TSa05_DonVi_.[ThoiGianSua],
            TSa05_DonVi_.[IpSua],
            CAST(BINARY_CHECKSUM(TSa05_DonVi_.[ID],TSa05_DonVi_.[TenTat],TSa05_DonVi_.[TenDonVi],TSa05_DonVi_.[LoaiDonViID],TSa05_DonVi_.[DiaChi],TSa05_DonVi_.[ThuTu],TSa05_DonVi_.[HoatDong],TSa05_DonVi_.[GhiChu],TSa05_DonVi_.[NguoiTao],TSa05_DonVi_.[ThoiGianTao],TSa05_DonVi_.[IpTao],TSa05_DonVi_.[NguoiSua],TSa05_DonVi_.[ThoiGianSua],TSa05_DonVi_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TSa05_DonVi_.[ID] = IS_ALIAS.[ID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TSa05_DonVi_.[ID],TSa05_DonVi_.[TenTat],TSa05_DonVi_.[TenDonVi],TSa05_DonVi_.[LoaiDonViID],TSa05_DonVi_.[DiaChi],TSa05_DonVi_.[ThuTu],TSa05_DonVi_.[HoatDong],TSa05_DonVi_.[GhiChu],TSa05_DonVi_.[NguoiTao],TSa05_DonVi_.[ThoiGianTao],TSa05_DonVi_.[IpTao],TSa05_DonVi_.[NguoiSua],TSa05_DonVi_.[ThoiGianSua],TSa05_DonVi_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tSa05_DonVi] TSa05_DonVi_ ' + 
            'WHERE 1=2;'
