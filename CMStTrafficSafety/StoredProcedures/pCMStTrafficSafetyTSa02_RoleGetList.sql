if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTSa02_RoleGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTSa02_RoleGetList 
GO
...
-- Returns a query resultset from table [dbo].[tSa02_Role]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTSa02_RoleGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TSa02_Role_.[ID] asc '
        ...
        SET @l_query_cols = 
            ...
            TSa02_Role_.[GhiChu],
            TSa02_Role_.[ThuTu],
            TSa02_Role_.[HoatDong],
            TSa02_Role_.[NguoiTao],
            TSa02_Role_.[ThoiGianTao],
            TSa02_Role_.[IpTao],
            TSa02_Role_.[NguoiSua],
            TSa02_Role_.[ThoiGianSua],
            TSa02_Role_.[IpSua],
            CAST(BINARY_CHECKSUM(TSa02_Role_.[ID],TSa02_Role_.[Role],TSa02_Role_.[Option1],TSa02_Role_.[Option2],TSa02_Role_.[Option3],TSa02_Role_.[GhiChu],TSa02_Role_.[ThuTu],TSa02_Role_.[HoatDong],TSa02_Role_.[NguoiTao],TSa02_Role_.[ThoiGianTao],TSa02_Role_.[IpTao],TSa02_Role_.[NguoiSua],TSa02_Role_.[ThoiGianSua],TSa02_Role_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TSa02_Role_.[ID] = IS_ALIAS.[ID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TSa02_Role_.[ID],TSa02_Role_.[Role],TSa02_Role_.[Option1],TSa02_Role_.[Option2],TSa02_Role_.[Option3],TSa02_Role_.[GhiChu],TSa02_Role_.[ThuTu],TSa02_Role_.[HoatDong],TSa02_Role_.[NguoiTao],TSa02_Role_.[ThoiGianTao],TSa02_Role_.[IpTao],TSa02_Role_.[NguoiSua],TSa02_Role_.[ThoiGianSua],TSa02_Role_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tSa02_Role] TSa02_Role_ ' + 
            'WHERE 1=2;'
