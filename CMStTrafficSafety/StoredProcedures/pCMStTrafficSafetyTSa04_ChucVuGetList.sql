if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTSa04_ChucVuGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTSa04_ChucVuGetList 
GO
...
-- Returns a query resultset from table [dbo].[tSa04_ChucVu]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTSa04_ChucVuGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TSa04_ChucVu_.[ID] asc '
        ...
        SET @l_query_cols = 
            N'TSa04_ChucVu_.[ID],
            TSa04_ChucVu_.[MaTat],
            TSa04_ChucVu_.[ChucVu],
            TSa04_ChucVu_.[Thutu],
            TSa04_ChucVu_.[HoatDong],
            TSa04_ChucVu_.[GhiChu],
            TSa04_ChucVu_.[NguoiTao],
            TSa04_ChucVu_.[ThoiGianTao],
            TSa04_ChucVu_.[IpTao],
            TSa04_ChucVu_.[NguoiSua],
            TSa04_ChucVu_.[ThoiGianSua],
            TSa04_ChucVu_.[IpSua],
            CAST(BINARY_CHECKSUM(TSa04_ChucVu_.[ID],TSa04_ChucVu_.[MaTat],TSa04_ChucVu_.[ChucVu],TSa04_ChucVu_.[Thutu],TSa04_ChucVu_.[HoatDong],TSa04_ChucVu_.[GhiChu],TSa04_ChucVu_.[NguoiTao],TSa04_ChucVu_.[ThoiGianTao],TSa04_ChucVu_.[IpTao],TSa04_ChucVu_.[NguoiSua],TSa04_ChucVu_.[ThoiGianSua],TSa04_ChucVu_.[IpSua]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TSa04_ChucVu_.[ID] = IS_ALIAS.[ID] ' 
