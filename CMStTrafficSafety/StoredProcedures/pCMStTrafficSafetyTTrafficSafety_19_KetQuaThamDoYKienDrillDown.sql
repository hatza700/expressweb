if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_19_KetQuaThamDoYKienDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_19_KetQuaThamDoYKienDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_19_KetQuaThamDoYKienDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_19_KetQuaThamDoYKien_]' +
