if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTSa03_UserRoleDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTSa03_UserRoleDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTSa03_UserRoleDrillDown
