if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_14_ChuyenNganhDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_14_ChuyenNganhDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_14_ChuyenNganhDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_14_ChuyenNganh_]' +
