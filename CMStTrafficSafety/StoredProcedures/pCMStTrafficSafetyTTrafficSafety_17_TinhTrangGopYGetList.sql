if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_17_TinhTrangGopYGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_17_TinhTrangGopYGetList 
GO
...
-- Returns a query resultset from table [dbo].[tTrafficSafety_17_TinhTrangGopY]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_17_TinhTrangGopYGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tTrafficSafety_17_TinhTrangGopY] TTrafficSafety_17_TinhTrangGopY_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TTrafficSafety_17_TinhTrangGopY_.[id] asc '
        ...
        SET @l_temp_colsWithAlias = 
            N'TTrafficSafety_17_TinhTrangGopY_.[id]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
        ...
        SET @l_query_cols = 
            N'TTrafficSafety_17_TinhTrangGopY_.[id],
            TTrafficSafety_17_TinhTrangGopY_.[TinhTrangGopY],
            CAST(BINARY_CHECKSUM(TTrafficSafety_17_TinhTrangGopY_.[id],TTrafficSafety_17_TinhTrangGopY_.[TinhTrangGopY]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TTrafficSafety_17_TinhTrangGopY_.[id] = IS_ALIAS.[id] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TTrafficSafety_17_TinhTrangGopY_.[id],TTrafficSafety_17_TinhTrangGopY_.[TinhTrangGopY]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tTrafficSafety_17_TinhTrangGopY] TTrafficSafety_17_TinhTrangGopY_ ' + 
            'WHERE 1=2;'
