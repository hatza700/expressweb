if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_28_Videos_typesGetList') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_28_Videos_typesGetList 
GO
...
-- Returns a query resultset from table [dbo].[tTrafficSafety_28_Videos_types]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_28_Videos_typesGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[tTrafficSafety_28_Videos_types] TTrafficSafety_28_V1417419848_'
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY TTrafficSafety_28_V1417419848_.[id] asc '
        ...
        SET @l_temp_colsWithAlias = 
            N'TTrafficSafety_28_V1417419848_.[id]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
        ...
        SET @l_query_cols = 
            N'TTrafficSafety_28_V1417419848_.[id],
            TTrafficSafety_28_V1417419848_.[KieuLienKet],
            CAST(BINARY_CHECKSUM(TTrafficSafety_28_V1417419848_.[id],TTrafficSafety_28_V1417419848_.[KieuLienKet]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345 '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON TTrafficSafety_28_V1417419848_.[id] = IS_ALIAS.[id] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(TTrafficSafety_28_V1417419848_.[id],TTrafficSafety_28_V1417419848_.[KieuLienKet]) AS nvarchar(4000)) AS IS_CHECKSUM_COLUMN_12345'
        SET @l_query_from = 
            ' FROM [dbo].[tTrafficSafety_28_Videos_types] TTrafficSafety_28_V1417419848_ ' + 
            'WHERE 1=2;'
