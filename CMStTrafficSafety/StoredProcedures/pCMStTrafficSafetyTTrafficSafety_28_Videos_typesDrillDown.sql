if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_28_Videos_typesDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_28_Videos_typesDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_28_Videos_typesDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_28_V1417419848_]' +
