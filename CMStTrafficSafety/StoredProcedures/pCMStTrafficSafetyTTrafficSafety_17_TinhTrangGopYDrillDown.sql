if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_17_TinhTrangGopYDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_17_TinhTrangGopYDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_17_TinhTrangGopYDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_17_TinhTrangGopY_]' +
