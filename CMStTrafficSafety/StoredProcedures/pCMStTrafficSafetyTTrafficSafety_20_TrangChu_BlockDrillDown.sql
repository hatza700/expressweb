if exists (select * from sysobjects where id = object_id(N'pCMStTrafficSafetyTTrafficSafety_20_TrangChu_BlockDrillDown') and sysstat & 0xf = 4) drop procedure pCMStTrafficSafetyTTrafficSafety_20_TrangChu_BlockDrillDown 
GO
...
CREATE PROCEDURE pCMStTrafficSafetyTTrafficSafety_20_TrangChu_BlockDrillDown
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_from = 
            ...
            'AS [TTrafficSafety_20_TrangChu_Block_]' +
