...
' This file implements the code-behind class for ShowTTrafficSafety_20_TrangChu_BlockTable.aspx.
' App_Code\ShowTTrafficSafety_20_TrangChu_BlockTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_20_TrangChu_BlockTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_20_TrangChu_BlockTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_20_TrangChu_BlockSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_20_TrangChu_BlockSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_20_TrangChu_BlockSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_20_TrangChu_BlockSearch().
      Return GetAutoCompletionList_TTrafficSafety_20_TrangChu_BlockSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Danh sách các block trang chủ"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_20_TrangChu_BlockTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_20_TrangChu_BlockSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_20_TrangChu_BlockTable.TTrafficSafety_20_TrangChu_BlockTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_20_TrangChu_BlockTable.TTrafficSafety_20_TrangChu_BlockTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_20_TrangChu_BlockSearch(prefixText, count)
        ...
        Me.TTrafficSafety_20_TrangChu_BlockTableControl.LoadData()
        Me.TTrafficSafety_20_TrangChu_BlockTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_20_TrangChu_BlockMenuItem"
                    End If
                End If
