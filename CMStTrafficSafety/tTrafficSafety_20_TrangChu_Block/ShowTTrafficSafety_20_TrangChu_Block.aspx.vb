...
' This file implements the code-behind class for ShowTTrafficSafety_20_TrangChu_Block.aspx.
' App_Code\ShowTTrafficSafety_20_TrangChu_Block.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_20_TrangChu_Block
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_20_TrangChu_Block page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết block trang chủ"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_20_TrangChu_Block/EditTTrafficSafety_20_TrangChu_Block.aspx?TTrafficSafety_20_TrangChu_Block={PK}"
