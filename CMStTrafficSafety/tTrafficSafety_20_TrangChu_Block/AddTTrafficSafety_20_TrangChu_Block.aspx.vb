...
' This file implements the code-behind class for AddTTrafficSafety_20_TrangChu_Block.aspx.
' App_Code\AddTTrafficSafety_20_TrangChu_Block.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_20_TrangChu_Block
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_20_TrangChu_Block page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm block trang chủ"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_20_TrangChu_BlockRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_20_TrangChu_BlockRecordControl.LoadData()
        Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_20_TrangChu_BlockRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource.GetValue(Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_20_TrangChu_BlockRecordControl.DataSource, Nothing,variables)
                      End If
