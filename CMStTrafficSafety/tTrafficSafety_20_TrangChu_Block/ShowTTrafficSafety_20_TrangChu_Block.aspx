...
<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_20_TrangChu_Block" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowTTrafficSafety_20_TrangChu_Block.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.ShowTTrafficSafety_20_TrangChu_Block" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <CMStTrafficSafety:TTrafficSafety_20_TrangChu_BlockRecordControl runat="server" id="TTrafficSafety_20_TrangChu_BlockRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="TTrafficSafety_20_TrangChu_BlockTitle" Text="Xem chi tiết block trang chủ">	</asp:Literal></td><td class="dhir"><asp:ImageButton runat="server" id="TTrafficSafety_20_TrangChu_BlockDialogEditButton" causesvalidation="False" commandname="Redirect" imageurl="../Images/iconEdit.gif" tooltip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;CMStTrafficSafety&quot;) %>">		
	</asp:ImageButton></td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>
</td></tr><tr><td><asp:panel id="TTrafficSafety_20_TrangChu_BlockRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="TTrafficSafety_20_TrangChu_BlockRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="ThuTuLabel" Text="Thu Tu">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="ThuTu"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="NguoiTaoLabel" Text="Nguoi Tao">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="NguoiTao"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="ThoiGianTaoLabel" Text="Thoi Gian Tao">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="ThoiGianTao"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="IpTaoLabel" Text="Ip Tao">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="IpTao"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="NguoiSuaLabel" Text="Nguoi Sua">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="NguoiSua"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="ThoiGianSuaLabel" Text="Thoi Gian Sua">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="ThoiGianSua"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="IpSuaLabel" Text="Ip Sua">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="IpSua"></asp:Literal> </td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="BlockLabel" Text="Block">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="Block"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="GhiChuLabel" Text="Ghi Chu">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="GhiChu"></asp:Literal> </td></tr></table></asp:panel>
</td></tr></table>
...
<tr><td class="ticnb" scope="row"><asp:ImageButton runat="server" id="TTrafficSafety_21_QuanLyTrangChuRowViewButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;CMStTrafficSafety&quot;) %>">		
	...
	</asp:ImageButton></td><td class="ticwb"><asp:CheckBox runat="server" id="TTrafficSafety_21_QuanLyTrangChuRecordRowSelection" onclick="moveToThisTableRow(this);">	</asp:CheckBox></td><td class="ttc"><asp:Literal runat="server" id="TenModule"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="ThuTu1"></asp:Literal> </td><td class="ttc"><asp:LinkButton runat="server" id="HienThiTieuDe" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc" style="text-align: right;"><asp:LinkButton runat="server" id="KieuNoiDung" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="ChuyenMuc"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="HoatDong"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="SoLuongTin"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="NguoiTao1"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ThoiGianTao1"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="IpTao1"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="NguoiSua1"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ThoiGianSua1"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="IpSua1"></asp:Literal> </td></tr></CMStTrafficSafety:TTrafficSafety_21_QuanLyTrangChuTableControlRow>
</ITEMTEMPLATE>
