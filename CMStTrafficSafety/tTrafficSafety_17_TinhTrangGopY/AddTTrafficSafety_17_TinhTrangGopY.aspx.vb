...
' This file implements the code-behind class for AddTTrafficSafety_17_TinhTrangGopY.aspx.
' App_Code\AddTTrafficSafety_17_TinhTrangGopY.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_17_TinhTrangGopY
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_17_TinhTrangGopY page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 17 Tinh Trang Gop Y"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_17_TinhTrangGopYRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_17_TinhTrangGopYRecordControl.LoadData()
        Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_17_TinhTrangGopYRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource.GetValue(Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_17_TinhTrangGopYRecordControl.DataSource, Nothing,variables)
                      End If
