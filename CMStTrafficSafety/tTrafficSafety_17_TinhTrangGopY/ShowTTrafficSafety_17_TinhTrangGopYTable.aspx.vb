...
' This file implements the code-behind class for ShowTTrafficSafety_17_TinhTrangGopYTable.aspx.
' App_Code\ShowTTrafficSafety_17_TinhTrangGopYTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_17_TinhTrangGopYTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_17_TinhTrangGopYTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_17_TinhTrangGopYSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_17_TinhTrangGopYSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_17_TinhTrangGopYSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_17_TinhTrangGopYSearch().
      Return GetAutoCompletionList_TTrafficSafety_17_TinhTrangGopYSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 17 Tinh Trang Gop Y"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_17_TinhTrangGopYTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_17_TinhTrangGopYSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_17_TinhTrangGopYTable.TTrafficSafety_17_TinhTrangGopYTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_17_TinhTrangGopYTable.TTrafficSafety_17_TinhTrangGopYTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_17_TinhTrangGopYSearch(prefixText, count)
        ...
        Me.TTrafficSafety_17_TinhTrangGopYTableControl.LoadData()
        Me.TTrafficSafety_17_TinhTrangGopYTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_17_TinhTrangGopYMenuItem"
                    End If
                End If
