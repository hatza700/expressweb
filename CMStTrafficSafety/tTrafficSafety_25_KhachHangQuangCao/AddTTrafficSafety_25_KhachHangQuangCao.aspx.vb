...
' This file implements the code-behind class for AddTTrafficSafety_25_KhachHangQuangCao.aspx.
' App_Code\AddTTrafficSafety_25_KhachHangQuangCao.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_25_KhachHangQuangCao
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_25_KhachHangQuangCao page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Thêm khách hàng quảng cáo")     
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm khách hàng quảng cáo"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_25_KhachHangQuangCaoRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_25_KhachHangQuangCaoRecordControl.LoadData()
        Me.TTrafficSafety_25_KhachHangQuangCaoRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_25_KhachHangQuangCao/ShowTTrafficSafety_25_KhachHangQuangCaoTable.aspx"
