...
' This file implements the code-behind class for EditTTrafficSafety_25_KhachHangQuangCao.aspx.
' App_Code\EditTTrafficSafety_25_KhachHangQuangCao.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_25_KhachHangQuangCao
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_25_KhachHangQuangCao page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Sửa khách hàng quảng cáo")     
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Sửa khách hàng quảng cáo"
        End Sub
