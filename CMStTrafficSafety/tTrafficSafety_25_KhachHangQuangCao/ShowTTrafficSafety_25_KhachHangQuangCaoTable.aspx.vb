...
' This file implements the code-behind class for ShowTTrafficSafety_25_KhachHangQuangCaoTable.aspx.
' App_Code\ShowTTrafficSafety_25_KhachHangQuangCaoTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_25_KhachHangQuangCaoTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_25_KhachHangQuangCaoTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Xem danh sách khách hàng quảng cáo")     
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_25_KhachHangQuangCaoSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_25_KhachHangQuangCaoSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_25_KhachHangQuangCaoSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_25_KhachHangQuangCaoSearch().
      Return GetAutoCompletionList_TTrafficSafety_25_KhachHangQuangCaoSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách khách hàng quảng cáo"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_25_KhachHangQuangCaoTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_25_KhachHangQuangCaoSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_25_KhachHangQuangCaoTable.TTrafficSafety_25_KhachHangQuangCaoTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_25_KhachHangQuangCaoTable.TTrafficSafety_25_KhachHangQuangCaoTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_25_KhachHangQuangCaoSearch(prefixText, count)
        ...
        Me.TTrafficSafety_25_KhachHangQuangCaoTableControl.LoadData()
        Me.TTrafficSafety_25_KhachHangQuangCaoTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_25_KhachHangQuangCaoMenuItem"
                    End If
                End If
