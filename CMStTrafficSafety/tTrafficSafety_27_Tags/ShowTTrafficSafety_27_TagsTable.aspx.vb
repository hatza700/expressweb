...
' This file implements the code-behind class for ShowTTrafficSafety_27_TagsTable.aspx.
' App_Code\ShowTTrafficSafety_27_TagsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_27_TagsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_27_TagsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_27_TagsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_27_TagsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_27_TagsSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_27_TagsSearch().
      Return GetAutoCompletionList_TTrafficSafety_27_TagsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 27 Tags"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_27_TagsTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_27_TagsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_27_TagsTable.TTrafficSafety_27_TagsTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_27_TagsTable.TTrafficSafety_27_TagsTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_27_TagsSearch(prefixText, count)
        ...
        Me.TTrafficSafety_27_TagsTableControl.LoadData()
        Me.TTrafficSafety_27_TagsTableControl.DataBind()
