...
' This file implements the code-behind class for ShowTTrafficSafety_27_Tags.aspx.
' App_Code\ShowTTrafficSafety_27_Tags.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_27_Tags
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_27_Tags page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_27_Tags/EditTTrafficSafety_27_Tags.aspx?TTrafficSafety_27_Tags={PK}"
