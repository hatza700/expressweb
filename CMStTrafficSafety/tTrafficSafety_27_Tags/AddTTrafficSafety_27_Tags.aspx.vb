...
' This file implements the code-behind class for AddTTrafficSafety_27_Tags.aspx.
' App_Code\AddTTrafficSafety_27_Tags.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_27_Tags
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_27_Tags page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 27 Tags"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_27_TagsRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_27_TagsRecordControl.LoadData()
        Me.TTrafficSafety_27_TagsRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_27_TagsRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_27_TagsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_27_TagsRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_27_TagsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_27_TagsRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_27_TagsRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_27_TagsRecordControl.DataSource.GetValue(Me.TTrafficSafety_27_TagsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_27_TagsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_27_TagsRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_27_TagsRecordControl.DataSource, Nothing,variables)
                      End If
