...
' This file implements the code-behind class for EditTSa01_User.aspx.
' App_Code\EditTSa01_User.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTSa01_User
        Inherits BaseApplicationPage
' Code-behind class for the EditTSa01_User page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Sửa người dùng")  
      End Sub
