...
' This file implements the code-behind class for ShowTSa01_UserTable.aspx.
' App_Code\ShowTSa01_UserTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa01_UserTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa01_UserTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách người dùng")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TSa01_UserSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTSa01_UserSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TSa01_UserSearch()
      ' or replace the call to GetAutoCompletionList_TSa01_UserSearch().
      Return GetAutoCompletionList_TSa01_UserSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách người dùng"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa01_UserTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TSa01_UserSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTSa01_UserTable.TSa01_UserTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTSa01_UserTable.TSa01_UserTableControl()
            
            Return control.GetAutoCompletionList_TSa01_UserSearch(prefixText, count)
        ...
        Me.TSa01_UserTableControl.LoadData()
        Me.TSa01_UserTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TSa01_UserMenuItem"
                    End If
                End If
