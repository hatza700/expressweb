...
' This file implements the code-behind class for ShowTSa01_User.aspx.
' App_Code\ShowTSa01_User.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa01_User
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa01_User page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Xem chi tiết người dùng")     
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết người dùng"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa01_User/EditTSa01_User.aspx?TSa01_User={PK}"
