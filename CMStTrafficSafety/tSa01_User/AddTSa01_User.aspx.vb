...
' This file implements the code-behind class for AddTSa01_User.aspx.
' App_Code\AddTSa01_User.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTSa01_User
        Inherits BaseApplicationPage
' Code-behind class for the AddTSa01_User page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
              write_log("Truy cập trang:Thêm người dùng")    
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm mới người dùng"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa01_UserRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TSa01_UserRecordControl.LoadData()
        Me.TSa01_UserRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa01_User/ShowTSa01_UserTable.aspx"
