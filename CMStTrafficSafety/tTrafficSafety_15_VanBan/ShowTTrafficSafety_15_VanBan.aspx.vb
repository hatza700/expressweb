...
' This file implements the code-behind class for ShowTTrafficSafety_15_VanBan.aspx.
' App_Code\ShowTTrafficSafety_15_VanBan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_15_VanBan
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_15_VanBan page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem chi tiết Văn bản QPPPL")      
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết văn bản quy phạm pháp luật"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_15_VanBan/EditTTrafficSafety_15_VanBan.aspx?TTrafficSafety_15_VanBan={PK}"
