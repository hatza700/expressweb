...
' This file implements the code-behind class for ShowTTrafficSafety_15_VanBanTable.aspx.
' App_Code\ShowTTrafficSafety_15_VanBanTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_15_VanBanTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_15_VanBanTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách Văn bản QPPPL")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_15_VanBanSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_15_VanBanSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_15_VanBanSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_15_VanBanSearch().
      Return GetAutoCompletionList_TTrafficSafety_15_VanBanSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách văn bản quy phạm pháp luật"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_15_VanBanTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_15_VanBanSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_15_VanBanTable.TTrafficSafety_15_VanBanTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_15_VanBanTable.TTrafficSafety_15_VanBanTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_15_VanBanSearch(prefixText, count)
        ...
        Me.TTrafficSafety_15_VanBanTableControl.LoadData()
        Me.TTrafficSafety_15_VanBanTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_15_VanBanMenuItem"
                    End If
                End If
