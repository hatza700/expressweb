...
<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.EditTTrafficSafety_15_VanBan" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditTTrafficSafety_15_VanBan.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.EditTTrafficSafety_15_VanBan" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <CMStTrafficSafety:TTrafficSafety_15_VanBanRecordControl runat="server" id="TTrafficSafety_15_VanBanRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="TTrafficSafety_15_VanBanTitle" Text="Sửa văn bản quy phạm pháp luật">	</asp:Literal></td></tr></table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="TinhTrangTextBoxMaxLengthValidator" ControlToValidate="TinhTrang" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;TinhTrang&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td></tr><tr><td class="fls"><asp:Literal runat="server" id="SoHieuVBLabel" Text="= &quot;Số hiệu Văn bản&quot;">	</asp:Literal></td><td class="dfv"><asp:TextBox runat="server" id="SoHieuVB" Columns="50" MaxLength="50" cssclass="field_input" width="200px"></asp:TextBox>&nbsp;
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="SoHieuVBTextBoxMaxLengthValidator" ControlToValidate="SoHieuVB" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;SoHieuVB&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="TrichYeuLabel" Text="= &quot;Trích yếu&quot;">	</asp:Literal></td><td class="dfv" colspan="3"><asp:TextBox runat="server" id="TrichYeu" MaxLength="50" columns="60" cssclass="field_input" rows="4" textmode="MultiLine" width="750px"></asp:TextBox>&nbsp;
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="GhiChuTextBoxMaxLengthValidator" ControlToValidate="GhiChu" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;GhiChu&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td></tr><tr><td class="fls"><asp:Literal runat="server" id="NguoiSuaLabel" Text="= &quot;Người sửa&quot;">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="NguoiSua"></asp:Literal> 
