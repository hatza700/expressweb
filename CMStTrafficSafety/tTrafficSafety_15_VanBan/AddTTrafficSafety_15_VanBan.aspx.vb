...
' This file implements the code-behind class for AddTTrafficSafety_15_VanBan.aspx.
' App_Code\AddTTrafficSafety_15_VanBan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_15_VanBan
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_15_VanBan page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Thêm Văn bản QPPPL")       
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm văn bản quy phạm pháp luật"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_15_VanBanRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_15_VanBanRecordControl.LoadData()
        Me.TTrafficSafety_15_VanBanRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_15_VanBan/ShowTTrafficSafety_15_VanBanTable.aspx"
