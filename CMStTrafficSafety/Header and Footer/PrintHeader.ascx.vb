...
Namespace CMStTrafficSafety.UI
  ...
  ' Code-behind class for the PrintHeader user control.
Partial Public Class PrintHeader
        Inherits BaseApplicationUserControl
        Implements IPrintHeader
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      End Sub  
        ...
        Public ReadOnly Property Logo() As System.Web.UI.WebControls.Image Implements IPrintHeader.Logo
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_Logo"), System.Web.UI.WebControls.Image)
            End Get
        End Property
                
      Public Overrides Property Visible() As Boolean Implements IPrintHeader.Visible
