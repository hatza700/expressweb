...
Partial Public Class HeaderMobile
        Inherits BaseApplicationUserControl
        Implements IHeaderMobile
...
#Region "Section 2: Do not modify this section."
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            AddHandler Me.SignIn.Button.Click, AddressOf SignIn_Click
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "SettingsIconMobile").Visible = False
            BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "SettingsCollapsibleRegionMobile").Visible = False
    ...
    End Function
      ...
      Select Case (DirectCast(Me.Page, BaseApplicationPage).CurrentSecurity.GetUserStatus())
            Case Nothing, ""
                      ...
                      Me.SignIn.Button.Text = GetResourceValue("Txt:SignIn", "CMStTrafficSafety")
                      Me.SignIn.Button.ToolTip = GetResourceValue("Txt:SignIn", "CMStTrafficSafety")
                    
      Case Else
          
                Me.SignIn.Button.Text = GetResourceValue("Txt:SignOut", "CMStTrafficSafety")
                Me.SignIn.Button.ToolTip = GetResourceValue("Txt:SignOut", "CMStTrafficSafety")
        ...
        Public ReadOnly Property Logo() As System.Web.UI.WebControls.Image Implements IHeaderMobile.Logo
            Get
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property SignIn() As IThemeButtonMobile Implements IHeaderMobile.SignIn
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_SignIn"), IThemeButtonMobile)
            End Get
        End Property
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property UserStatusLbl() As System.Web.UI.WebControls.Label Implements IHeaderMobile.UserStatusLbl
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "_UserStatusLbl"), System.Web.UI.WebControls.Label)
            End Get
        End Property
                
      Public Overrides Property Visible() As Boolean Implements IHeaderMobile.Visible
