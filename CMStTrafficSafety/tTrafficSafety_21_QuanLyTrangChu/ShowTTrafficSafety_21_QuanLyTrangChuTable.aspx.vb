...
' This file implements the code-behind class for ShowTTrafficSafety_21_QuanLyTrangChuTable.aspx.
' App_Code\ShowTTrafficSafety_21_QuanLyTrangChuTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_21_QuanLyTrangChuTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_21_QuanLyTrangChuTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
                write_log("Truy cập trang:Xem danh sách module CT")  
      End Sub
...
'      <Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_TTrafficSafety_21_QuanLyTrangChuSearch(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetTTrafficSafety_21_QuanLyTrangChuSearchCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_21_QuanLyTrangChuSearch()
'      ' or replace the call to GetAutoCompletionList_TTrafficSafety_21_QuanLyTrangChuSearch().
'      Return GetAutoCompletionList_TTrafficSafety_21_QuanLyTrangChuSearch_Base(prefixText, count)
'      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Danh sách module trên trang chủ"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_21_QuanLyTrangChuTableControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_21_QuanLyTrangChuTableControl.LoadData()
        Me.TTrafficSafety_21_QuanLyTrangChuTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_21_QuanLyTrangChuMenuItem"
                    End If
                End If
