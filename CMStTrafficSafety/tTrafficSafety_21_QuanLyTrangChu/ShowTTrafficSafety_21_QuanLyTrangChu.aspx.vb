...
' This file implements the code-behind class for ShowTTrafficSafety_21_QuanLyTrangChu.aspx.
' App_Code\ShowTTrafficSafety_21_QuanLyTrangChu.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_21_QuanLyTrangChu
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_21_QuanLyTrangChu page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem chi tiết module CT")      
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết module"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_21_QuanLyTrangChu/EditTTrafficSafety_21_QuanLyTrangChu.aspx?TTrafficSafety_21_QuanLyTrangChu={PK}"
