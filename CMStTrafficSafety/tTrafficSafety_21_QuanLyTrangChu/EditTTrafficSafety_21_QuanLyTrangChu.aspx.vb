...
' This file implements the code-behind class for EditTTrafficSafety_21_QuanLyTrangChu.aspx.
' App_Code\EditTTrafficSafety_21_QuanLyTrangChu.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_21_QuanLyTrangChu
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_21_QuanLyTrangChu page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Sửa module CT")      
      End Sub
