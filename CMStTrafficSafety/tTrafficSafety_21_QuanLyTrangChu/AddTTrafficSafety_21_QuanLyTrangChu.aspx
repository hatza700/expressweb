<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddTTrafficSafety_21_QuanLyTrangChu.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.AddTTrafficSafety_21_QuanLyTrangChu" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.AddTTrafficSafety_21_QuanLyTrangChu" %>
...
<CMStTrafficSafety:TTrafficSafety_21_QuanLyTrangChuRecordControl runat="server" id="TTrafficSafety_21_QuanLyTrangChuRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="TTrafficSafety_21_QuanLyTrangChuTitle" Text="Thêm mới module">	</asp:Literal></td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>
</td></tr><tr><td><asp:panel id="TTrafficSafety_21_QuanLyTrangChuRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="TTrafficSafety_21_QuanLyTrangChuRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="TenModuleLabel" Text="= &quot;Tên module&quot;">	</asp:Literal></td><td class="dfv" colspan="3"><asp:TextBox runat="server" id="TenModule" MaxLength="50" columns="60" cssclass="field_input" rows="2" textmode="MultiLine" width="750px"></asp:TextBox>&nbsp;
...
</td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="KieuNoiDungLabel" Text="= &quot;Kiểu module&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><asp:DropDownList runat="server" id="KieuNoiDung" autopostback="True" causesvalidation="True" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)" width="300px"></asp:DropDownList>
...
<asp:Button runat="server" id="PushButton" causesvalidation="False" commandname="Redirect" consumers="page" cssclass="abc" postback="True" text="MyPushButton">		
	</asp:Button>

</td><td class="fls"><asp:Literal runat="server" id="ChuyenMucLabel" Text="= &quot;Danh mục tin tức&quot;">	</asp:Literal></td><td class="dfv"><asp:DropDownList runat="server" id="ChuyenMuc" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)" width="300px"></asp:DropDownList></td></tr><tr><td class="fls"><asp:Literal runat="server" id="HienThiTieuDeLabel" Text="= &quot;Hiển thị tiêu đề&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><asp:DropDownList runat="server" id="HienThiTieuDe" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)" width="300px"></asp:DropDownList>
<Selectors:FvLlsHyperLink runat="server" id="HienThiTieuDeFvLlsHyperLink" ControlToUpdate="HienThiTieuDe" Text="&lt;%# GetResourceValue(&quot;LLS:Text&quot;, &quot;CMStTrafficSafety&quot;) %>" MinListItems="100" Table="tTrafficSafety_22_HienThiTieuDeModule" Field="TTrafficSafety_22_HienThiTieuDeModule_.id" DisplayField="%3dTTrafficSafety_22_HienThiTieuDeModule.KieuHienThi"></Selectors:FvLlsHyperLink></td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="SoLuongTinLabel" Text="= &quot;Số lượng tin&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><table border="0" cellpadding="0" cellspacing="0">
<tr>
...
</td><td class="fls"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="ThuTuLabel" Text="= &quot;Thứ tự&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="ThuTu" Columns="14" MaxLength="14" cssclass="field_input" width="70px"></asp:TextBox></td>
<td>
&nbsp;
...
</td><td class="fls"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="HoatDongLabel" Text="= &quot;Hoạt động&quot;">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><asp:CheckBox runat="server" id="HoatDong"></asp:CheckBox></td><td class="fls"></td><td class="dfv" style="white-space:nowrap;"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="NguoiTaoLabel" Text="= &quot;Người tạo&quot;">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="NguoiTao"></asp:Literal> 
<asp:Literal runat="server" id="IpTao"></asp:Literal> 
<asp:Literal runat="server" id="ThoiGianTao"></asp:Literal></td><td class="fls"></td><td class="dfv"></td></tr></table></asp:panel>
</td></tr></table>
...
jQuery(document).ready(function() {
  ...
  try
  {
   ...
   var s = this.id;
if(s.indexOf("KieuNoiDung") > -1)
{
	//	jQuery("<%=PushButton.ClientID%>").trigger( "click" );
	//	alert(this.id);
