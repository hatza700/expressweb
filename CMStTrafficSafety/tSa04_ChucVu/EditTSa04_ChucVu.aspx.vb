...
' This file implements the code-behind class for EditTSa04_ChucVu.aspx.
' App_Code\EditTSa04_ChucVu.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTSa04_ChucVu
        Inherits BaseApplicationPage
' Code-behind class for the EditTSa04_ChucVu page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Sửa Chức vụ")       
      End Sub
