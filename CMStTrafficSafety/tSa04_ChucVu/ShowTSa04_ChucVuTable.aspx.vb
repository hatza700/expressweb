...
' This file implements the code-behind class for ShowTSa04_ChucVuTable.aspx.
' App_Code\ShowTSa04_ChucVuTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa04_ChucVuTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa04_ChucVuTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Xem danh sách  Chức vụ")     
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TSa04_ChucVuSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTSa04_ChucVuSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TSa04_ChucVuSearch()
      ' or replace the call to GetAutoCompletionList_TSa04_ChucVuSearch().
      Return GetAutoCompletionList_TSa04_ChucVuSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách chức vụ"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa04_ChucVuTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TSa04_ChucVuSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTSa04_ChucVuTable.TSa04_ChucVuTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTSa04_ChucVuTable.TSa04_ChucVuTableControl()
            
            Return control.GetAutoCompletionList_TSa04_ChucVuSearch(prefixText, count)
        ...
        Me.TSa04_ChucVuTableControl.LoadData()
        Me.TSa04_ChucVuTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TSa04_ChucVuMenuItem"
                    End If
                End If
