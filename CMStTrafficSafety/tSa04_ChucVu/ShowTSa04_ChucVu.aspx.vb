...
' This file implements the code-behind class for ShowTSa04_ChucVu.aspx.
' App_Code\ShowTSa04_ChucVu.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTSa04_ChucVu
        Inherits BaseApplicationPage
' Code-behind class for the ShowTSa04_ChucVu page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Xem chi tiết Chức vụ")        
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết chức vụ"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa04_ChucVu/EditTSa04_ChucVu.aspx?TSa04_ChucVu={PK}"
