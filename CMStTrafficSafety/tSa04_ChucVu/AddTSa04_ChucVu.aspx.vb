...
' This file implements the code-behind class for AddTSa04_ChucVu.aspx.
' App_Code\AddTSa04_ChucVu.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTSa04_ChucVu
        Inherits BaseApplicationPage
' Code-behind class for the AddTSa04_ChucVu page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Thêm Chức vụ")     
      End Sub
...
#Region "Section 2: Do not modify this section."
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TSa04_ChucVuRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TSa04_ChucVuRecordControl.LoadData()
        Me.TSa04_ChucVuRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tSa04_ChucVu/ShowTSa04_ChucVuTable.aspx"
