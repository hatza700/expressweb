...
' This file implements the code-behind class for AddTTrafficSafety_24_ViTriQuangCao.aspx.
' App_Code\AddTTrafficSafety_24_ViTriQuangCao.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_24_ViTriQuangCao
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_24_ViTriQuangCao page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 24 Vi Tri Quang Cao"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.LoadData()
        Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_24_ViTriQuangCaoRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource.Id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource.GetValue(Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_24_ViTriQuangCaoRecordControl.DataSource, Nothing,variables)
                      End If
