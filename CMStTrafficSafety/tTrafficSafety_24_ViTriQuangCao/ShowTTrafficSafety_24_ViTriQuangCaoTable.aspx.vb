...
' This file implements the code-behind class for ShowTTrafficSafety_24_ViTriQuangCaoTable.aspx.
' App_Code\ShowTTrafficSafety_24_ViTriQuangCaoTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_24_ViTriQuangCaoTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_24_ViTriQuangCaoTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_24_ViTriQuangCaoSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_24_ViTriQuangCaoSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_24_ViTriQuangCaoSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_24_ViTriQuangCaoSearch().
      Return GetAutoCompletionList_TTrafficSafety_24_ViTriQuangCaoSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 24 Vi Tri Quang Cao"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_24_ViTriQuangCaoTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_24_ViTriQuangCaoSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_24_ViTriQuangCaoTable.TTrafficSafety_24_ViTriQuangCaoTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_24_ViTriQuangCaoTable.TTrafficSafety_24_ViTriQuangCaoTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_24_ViTriQuangCaoSearch(prefixText, count)
        ...
        Me.TTrafficSafety_24_ViTriQuangCaoTableControl.LoadData()
        Me.TTrafficSafety_24_ViTriQuangCaoTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_24_ViTriQuangCaoMenuItem"
                    End If
                End If
