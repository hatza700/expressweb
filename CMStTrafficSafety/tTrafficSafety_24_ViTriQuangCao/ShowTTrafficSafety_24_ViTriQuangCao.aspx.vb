...
' This file implements the code-behind class for ShowTTrafficSafety_24_ViTriQuangCao.aspx.
' App_Code\ShowTTrafficSafety_24_ViTriQuangCao.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_24_ViTriQuangCao
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_24_ViTriQuangCao page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_24_ViTriQuangCao/EditTTrafficSafety_24_ViTriQuangCao.aspx?TTrafficSafety_24_ViTriQuangCao={PK}"
