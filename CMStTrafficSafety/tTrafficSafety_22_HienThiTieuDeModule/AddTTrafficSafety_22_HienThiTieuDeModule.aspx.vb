...
' This file implements the code-behind class for AddTTrafficSafety_22_HienThiTieuDeModule.aspx.
' App_Code\AddTTrafficSafety_22_HienThiTieuDeModule.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_22_HienThiTieuDeModule
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_22_HienThiTieuDeModule page.
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Traffic Safety 22 Hien Thi Tieu De Module"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.LoadData()
        Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataBind()
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource.id0.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource.GetValue(Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_22_HienThiTieuDeModuleRecordControl.DataSource, Nothing,variables)
                      End If
