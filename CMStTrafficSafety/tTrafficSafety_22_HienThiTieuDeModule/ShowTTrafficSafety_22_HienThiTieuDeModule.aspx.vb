...
' This file implements the code-behind class for ShowTTrafficSafety_22_HienThiTieuDeModule.aspx.
' App_Code\ShowTTrafficSafety_22_HienThiTieuDeModule.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_22_HienThiTieuDeModule
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_22_HienThiTieuDeModule page.
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_22_HienThiTieuDeModule/EditTTrafficSafety_22_HienThiTieuDeModule.aspx?TTrafficSafety_22_HienThiTieuDeModule={PK}"
