...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowTTrafficSafety_22_HienThiTieuDeModule.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.ShowTTrafficSafety_22_HienThiTieuDeModule" %>
<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_22_HienThiTieuDeModule" %>
...
<tr><td class="ticnb" scope="row"><asp:ImageButton runat="server" id="TTrafficSafety_21_QuanLyTrangChuRowViewButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;CMStTrafficSafety&quot;) %>">		
	...
	</asp:ImageButton></td><td class="ticwb"><asp:CheckBox runat="server" id="TTrafficSafety_21_QuanLyTrangChuRecordRowSelection" onclick="moveToThisTableRow(this);">	</asp:CheckBox></td><td class="ttc"><asp:Literal runat="server" id="TenModule"></asp:Literal> </td><td class="ttc"><asp:LinkButton runat="server" id="ThuocBlock" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="ThuTu"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:LinkButton runat="server" id="KieuNoiDung" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="ChuyenMuc"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="HoatDong"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="SoLuongTin"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="NguoiTao"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ThoiGianTao"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="IpTao"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="NguoiSua"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ThoiGianSua"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="IpSua"></asp:Literal> </td></tr></CMStTrafficSafety:TTrafficSafety_21_QuanLyTrangChuTableControlRow>
</ITEMTEMPLATE>
