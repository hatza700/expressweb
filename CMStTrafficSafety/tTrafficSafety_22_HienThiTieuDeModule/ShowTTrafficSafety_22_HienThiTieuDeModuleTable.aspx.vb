...
' This file implements the code-behind class for ShowTTrafficSafety_22_HienThiTieuDeModuleTable.aspx.
' App_Code\ShowTTrafficSafety_22_HienThiTieuDeModuleTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_22_HienThiTieuDeModuleTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_22_HienThiTieuDeModuleTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_22_HienThiTieuDeModuleSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_22_HienThiTieuDeModuleSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_22_HienThiTieuDeModuleSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_22_HienThiTieuDeModuleSearch().
      Return GetAutoCompletionList_TTrafficSafety_22_HienThiTieuDeModuleSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Traffic Safety 22 Hien Thi Tieu De Module"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_22_HienThiTieuDeModuleTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_22_HienThiTieuDeModuleSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_22_HienThiTieuDeModuleTable.TTrafficSafety_22_HienThiTieuDeModuleTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_22_HienThiTieuDeModuleTable.TTrafficSafety_22_HienThiTieuDeModuleTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_22_HienThiTieuDeModuleSearch(prefixText, count)
        ...
        Me.TTrafficSafety_22_HienThiTieuDeModuleTableControl.LoadData()
        Me.TTrafficSafety_22_HienThiTieuDeModuleTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_22_HienThiTieuDeModuleMenuItem"
                    End If
                End If
