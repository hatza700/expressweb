...
' This file implements the code-behind class for ShowTTrafficSafety_18_ThamDoYKienTable.aspx.
' App_Code\ShowTTrafficSafety_18_ThamDoYKienTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_18_ThamDoYKienTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_18_ThamDoYKienTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách  thăm dò ý kiến")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_18_ThamDoYKienSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_18_ThamDoYKienSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_18_ThamDoYKienSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_18_ThamDoYKienSearch().
      Return GetAutoCompletionList_TTrafficSafety_18_ThamDoYKienSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Danh sách câu hỏi thăm dò ý kiến"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_18_ThamDoYKienTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_18_ThamDoYKienSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_18_ThamDoYKienTable.TTrafficSafety_18_ThamDoYKienTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_18_ThamDoYKienTable.TTrafficSafety_18_ThamDoYKienTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_18_ThamDoYKienSearch(prefixText, count)
        ...
        Me.TTrafficSafety_18_ThamDoYKienTableControl.LoadData()
        Me.TTrafficSafety_18_ThamDoYKienTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_18_ThamDoYKienMenuItem"
                    End If
                End If
