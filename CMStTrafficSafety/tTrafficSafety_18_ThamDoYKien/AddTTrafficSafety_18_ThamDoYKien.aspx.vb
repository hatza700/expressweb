...
' This file implements the code-behind class for AddTTrafficSafety_18_ThamDoYKien.aspx.
' App_Code\AddTTrafficSafety_18_ThamDoYKien.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_18_ThamDoYKien
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_18_ThamDoYKien page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
          write_log("Truy cập trang:Thêm câu hỏi thăm dò ý kiến")        
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm câu hỏi thăm dò ý kiến"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_18_ThamDoYKienRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_18_ThamDoYKienRecordControl.LoadData()
        Me.TTrafficSafety_18_ThamDoYKienRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_18_ThamDoYKien/ShowTTrafficSafety_18_ThamDoYKienTable.aspx"
