<%@ Register Tagprefix="CMStTrafficSafety" Namespace="CMStTrafficSafety.UI.Controls.AddTTrafficSafety_18_ThamDoYKien" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddTTrafficSafety_18_ThamDoYKien.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="CMStTrafficSafety.UI.AddTTrafficSafety_18_ThamDoYKien" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <CMStTrafficSafety:TTrafficSafety_18_ThamDoYKienRecordControl runat="server" id="TTrafficSafety_18_ThamDoYKienRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="TTrafficSafety_18_ThamDoYKienTitle" Text="Thêm câu hỏi thăm dò ý kiến">	</asp:Literal></td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>
</td></tr><tr><td><asp:panel id="TTrafficSafety_18_ThamDoYKienRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="TTrafficSafety_18_ThamDoYKienRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="CauHoiThamDoLabel" Text="= &quot;Câu hỏi thăm dò&quot;">	</asp:Literal></td><td class="dfv"><asp:TextBox runat="server" id="CauHoiThamDo" MaxLength="50" columns="0" cssclass="field_input" rows="1" textmode="MultiLine" width="750px"></asp:TextBox>&nbsp;
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="ThoiGianKetThucTextBoxMaxLengthValidator" ControlToValidate="ThoiGianKetThuc" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;CMStTrafficSafety&quot;).Replace(&quot;{FieldName}&quot;, &quot;ThoiGianKetThuc&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="fls"><asp:Literal runat="server" id="NguoiTaoLabel" Text="= &quot;Người tạo&quot;">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="NguoiTao"></asp:Literal> 
