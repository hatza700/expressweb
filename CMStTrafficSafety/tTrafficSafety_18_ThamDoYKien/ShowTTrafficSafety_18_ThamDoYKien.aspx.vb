...
' This file implements the code-behind class for ShowTTrafficSafety_18_ThamDoYKien.aspx.
' App_Code\ShowTTrafficSafety_18_ThamDoYKien.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_18_ThamDoYKien
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_18_ThamDoYKien page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem chi tiết  thăm dò ý kiến")      
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết câu hỏi thăm dò ý kiến"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_18_ThamDoYKien/EditTTrafficSafety_18_ThamDoYKien.aspx?TTrafficSafety_18_ThamDoYKien={PK}"
