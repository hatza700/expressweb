...
' This file implements the code-behind class for AddTTrafficSafety_29_Album_anh.aspx.
' App_Code\AddTTrafficSafety_29_Album_anh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_29_Album_anh
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_29_Album_anh page.
...
#Region "Section 2: Do not modify this section."
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TTrafficSafety_29_Album_anhRecordControl Is Nothing AndAlso Not Me.TTrafficSafety_29_Album_anhRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TTrafficSafety_29_Album_anhRecordControl.DataSource.albumid.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_29_Album_anhRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_29_Album_anhRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TTrafficSafety_29_Album_anhRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TTrafficSafety_29_Album_anhRecordControl.DataSource.GetValue(Me.TTrafficSafety_29_Album_anhRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TTrafficSafety_29_Album_anhRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TTrafficSafety_29_Album_anhRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TTrafficSafety_29_Album_anhRecordControl.DataSource, Nothing,variables)
                      End If
