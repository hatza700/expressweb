...
' This file implements the code-behind class for SearchEditTTrafficSafety_29_Album_anh.aspx.
' App_Code\SearchEditTTrafficSafety_29_Album_anh.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class SearchEditTTrafficSafety_29_Album_anh
        Inherits BaseApplicationPage
' Code-behind class for the SearchEditTTrafficSafety_29_Album_anh page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_29_Album_anhSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_29_Album_anhSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_29_Album_anhSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_29_Album_anhSearch().
      Return GetAutoCompletionList_TTrafficSafety_29_Album_anhSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Search") + " Traffic Safety 29 Album Anh"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_29_Album_anhRecordControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_29_Album_anhSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.SearchEditTTrafficSafety_29_Album_anh.TTrafficSafety_29_Album_anhRecordControl 
            control = new CMStTrafficSafety.UI.Controls.SearchEditTTrafficSafety_29_Album_anh.TTrafficSafety_29_Album_anhRecordControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_29_Album_anhSearch(prefixText, count)
        ...
        Me.TTrafficSafety_29_Album_anhRecordControl.LoadData()
        Me.TTrafficSafety_29_Album_anhRecordControl.DataBind()
