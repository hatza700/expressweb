...
' This file implements the code-behind class for AddTTrafficSafety_12_HinhThucVanBan.aspx.
' App_Code\AddTTrafficSafety_12_HinhThucVanBan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTTrafficSafety_12_HinhThucVanBan
        Inherits BaseApplicationPage
' Code-behind class for the AddTTrafficSafety_12_HinhThucVanBan page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
           write_log("Truy cập trang:Thêm Hình thức văn bản")       
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Thêm hình thức văn bản"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_12_HinhThucVanBanRecordControl.SaveData()
      ...
      End Sub  
        ...
        Me.TTrafficSafety_12_HinhThucVanBanRecordControl.LoadData()
        Me.TTrafficSafety_12_HinhThucVanBanRecordControl.DataBind()
        ...
        Public Sub CancelButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_12_HinhThucVanBan/ShowTTrafficSafety_12_HinhThucVanBanTable.aspx"
