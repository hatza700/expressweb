...
' This file implements the code-behind class for ShowTTrafficSafety_12_HinhThucVanBanTable.aspx.
' App_Code\ShowTTrafficSafety_12_HinhThucVanBanTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_12_HinhThucVanBanTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_12_HinhThucVanBanTable page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Xem danh sách Hình thức văn bản")      
      End Sub
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TTrafficSafety_12_HinhThucVanBanSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTTrafficSafety_12_HinhThucVanBanSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TTrafficSafety_12_HinhThucVanBanSearch()
      ' or replace the call to GetAutoCompletionList_TTrafficSafety_12_HinhThucVanBanSearch().
      Return GetAutoCompletionList_TTrafficSafety_12_HinhThucVanBanSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem danh sách hình thức văn bản"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TTrafficSafety_12_HinhThucVanBanTableControl.SaveData()
      ...
      End Sub  
        ...
        Public Shared Function GetAutoCompletionList_TTrafficSafety_12_HinhThucVanBanSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_12_HinhThucVanBanTable.TTrafficSafety_12_HinhThucVanBanTableControl 
            control = new CMStTrafficSafety.UI.Controls.ShowTTrafficSafety_12_HinhThucVanBanTable.TTrafficSafety_12_HinhThucVanBanTableControl()
            
            Return control.GetAutoCompletionList_TTrafficSafety_12_HinhThucVanBanSearch(prefixText, count)
        ...
        Me.TTrafficSafety_12_HinhThucVanBanTableControl.LoadData()
        Me.TTrafficSafety_12_HinhThucVanBanTableControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TTrafficSafety_12_HinhThucVanBanMenuItem"
                    End If
                End If
