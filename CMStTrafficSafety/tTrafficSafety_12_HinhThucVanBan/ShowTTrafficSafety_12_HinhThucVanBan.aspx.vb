...
' This file implements the code-behind class for ShowTTrafficSafety_12_HinhThucVanBan.aspx.
' App_Code\ShowTTrafficSafety_12_HinhThucVanBan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTTrafficSafety_12_HinhThucVanBan
        Inherits BaseApplicationPage
' Code-behind class for the ShowTTrafficSafety_12_HinhThucVanBan page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
             write_log("Truy cập trang:Xem chi tiết Hình thức văn bản")     
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Xem chi tiết hình thức văn bản"
        End Sub
      ...
      End Sub  
        ...
        Public Sub EditButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../tTrafficSafety_12_HinhThucVanBan/EditTTrafficSafety_12_HinhThucVanBan.aspx?TTrafficSafety_12_HinhThucVanBan={PK}"
