...
' This file implements the code-behind class for EditTTrafficSafety_12_HinhThucVanBan.aspx.
' App_Code\EditTTrafficSafety_12_HinhThucVanBan.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTTrafficSafety_12_HinhThucVanBan
        Inherits BaseApplicationPage
' Code-behind class for the EditTTrafficSafety_12_HinhThucVanBan page.
...
#Region "Section 1: Place your customizations here."
      ...
      Public Sub LoadData()
          ...
          LoadData_Base()
            write_log("Truy cập trang:Sửa Hình thức văn bản")      
      End Sub
...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = "Sửa hình thức văn bản"
        End Sub
